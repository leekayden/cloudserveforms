...
{
    /**
     * This is a hash of page identifiers to URLs. Every page in CloudserveForms has a unique page identifier
     ...
     *
     * @param string $page_identifier special strings that have meaning to CloudserveForms, used to identify
     *                  pages within its interface. See the top of /global/code/menus.php for a list.
     * @param string $custom_options again used by CloudserveForms
    ...
    /**
     * Used on every page within CloudserveForms, this function builds the URL for a page *as it should be*, e.g. if they're
