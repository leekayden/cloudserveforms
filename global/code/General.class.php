...
class General
{
	...
	/**
	 * Gets a list of known CloudserveForms tables in a database.
	 * @return array
	 */
...
END;
	...
	public static function verifyCoreTablesExist()
	{
		...
		if (!$all_tables_found) {
			...
			Errors::majorError("CloudserveForms couldn't find all the database tables. Please check your /global/config.php file to confirm the <b>\$g_table_prefix</b> setting. The following tables are missing: {$missing_tables_str}");
			exit;
		}
	}
