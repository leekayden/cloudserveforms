...
/**
 * Handles database sessions. By default CloudserveForms uses PHP sessions, not database sessions. To enable this
...
/**
 * Overrides the default PHP (file-based) sessions with database sessions, allowing using CloudserveForms being hosted
 * on multiple servers.
 */
