...
class Errors
{
    ...
    public static $CODES = array(
        "100" => 100,
        "101" => 101,
        // 102, 103, 104, 105 removed in CloudserveForms 3
        "106" => 106
    );
...
END;
     ...
     * process and shows an Uh-oh page. This was added in CloudserveForms 3. Before that, the vast majority of database
...
END;
    ...
    public static function handleError($error_message, $debug_details = "", $error_type = "error")
    {
        ...
        // redirect to the error page in the current CloudserveForms folder
//        if (!empty($root_url)) {
//            $root_url = "$root_url/";
//        }
