...
/**
 * CloudserveForms - generic form processing, storage and access script
 *
...
class Core
{
	...
	/**
	 * This is the base URL of the CloudserveForms installation on your server. e.g.
	...
	/**
	 * The server directory path to your CloudserveForms folder.
	 */
	...
	/**
	 * This value lets you define a custom database prefix for your CloudserveForms tables. This is handy if
	 * CloudserveForms will be added to an existing database and you want to avoid table naming conflicts.
	 */
	...
	/**
	 * This controls the maximum number of pagination links that appear in the CloudserveForms UI (e.g. for
	...
	/**
	 * The size of the password_history setting in the settings table. CloudserveForms keeps track of the last 10
	...
	/**
	 * Added in 3.0.1, the $g_use_smarty_bc setting in the /global/config.php file makes CloudserveForms use the
	...
	/**
	 * The current version of the CloudserveForms Core.
	 */
	...
	/**
	 * The minimum required PHP version needed to run CloudserveForms.
	 */
	...
	/**
	 * Initializes the Core singleton for use throughout CloudserveForms.
	...
	public static function startSessions($context = "")
	{
		...
		// CloudserveForms uses utf-8 for all headers; if the user is using this method in an API page they can choose to
	...
	// the 3.0.15 upgrade tries to create a cache/ folder in the CloudserveForms root and switch the installation over to use
	// that. In case of problems CloudserveForms downgrades to using the old default theme's cache folder. This method is
