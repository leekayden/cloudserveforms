...
class FieldTypes
{
	 ...
	 * has meaning to the browser - to signify that you want an input field. CloudserveForms field types are a totally
	 ...
	 *
	 * For instance, if you create a Date field type within CloudserveForms, it's really just a <input type="text" />
