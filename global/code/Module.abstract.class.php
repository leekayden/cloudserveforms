...
/**
 * Our base class for all Modules. All CloudserveForms modules need to extend this abstract class to be recognized by the
 * script.
...
abstract class Module {
     ...
     *    {FTROOT} - the CloudserveForms root URL
     *    {FTVERSION} - the current CloudserveForms version
