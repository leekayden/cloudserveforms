...
class Hooks {
    ...
    /**
     * Called automatically after upgrading the Core, theme or module. This parses the entire CloudserveForms code base -
    ...
    public static function processHookCalls($event, $vars, $overridable_vars, $overridable_vars_to_be_concatenated = array())
    {
        ...
        foreach ($hooks as $hook_info) {
            ...
            // prefix was added to reduce the likelihood of naming conflicts with variables in any CloudserveForms page
