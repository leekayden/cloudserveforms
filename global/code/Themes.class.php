...
/**
 * This file defines all methods relating to CloudserveForms themes. Note: the Theme setting tab/page
...
#
	...
	/**
	 * Used by every page in the CloudserveForms UI to render a page.
	 *
