...
class API
{
     ...
     * to embed any special PHP logic in your forms to ensure the data gets submitted to CloudserveForms properly.
     *
     ...
     *         this submission; but it only shows up in the CloudserveForms UI if you explicitly tell CloudserveForms that the
     ...
     *               editable via this function and makes the submission appear in the CloudserveForms UI.
     ...
     *        "send_emails": (boolean). By default, CloudserveForms will trigger any emails that have been attached to the
