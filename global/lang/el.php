...
$LANG["text_add_form_help_link"] = "Αν αντιμετωπίσετε οποιοδήποτε πρόβλημα κατά τη διάρκεια αυτών των βημάτων, προσπαθήστε να διαβάσετε τα <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">έγγραφα των χρηστών</a> .";
...
$LANG["text_add_form_step_3_para_2"] = "Σημείωση: εάν στέλνετε πολλές τιμές μέσω πλαίσια ελέγχου ή ένα πολυ-επιλέξτε κουτί, βεβαιωθείτε ότι το όνομα τομέα σας τελειώνει με το [] χαρακτήρες (βλ. την <a href=\"http://docs.forms.cloudservetechcentral.com/\" target=\"_blank\">τεκμηρίωση χρήστη</a> για περισσότερες πληροφορίες).";
...
$LANG["text_install_email_content_text"] = "Υπάρχουν αρκετοί πόροι στον ιστότοπό μας για να σας βοηθήσουμε να ξεκινήσετε, συμπεριλαμβανομένης της ηλεκτρονικής τεκμηρίωσης (https://docs.forms.cloudservetechcentral.com) και των σεμιναρίων (https://docs.forms.cloudservetechcentral.com/tutorials). Εάν διαπιστώσετε ότι έχετε κολλήσει ή έχετε κάποια ερώτηση, ρωτήστε μια ερώτηση σχετικά με το github (https://github.com/formtools/core/issues/).";
$LANG["text_install_form_tools_server_not_supported"] = "Λυπούμαστε, Εργαλεία φόρμας δεν θα είναι σε θέση να τρέξει στον server σας. <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">Παρακαλώ κάντε κλικ εδώ</a> για τις ελάχιστες απαιτήσεις.";
...
$LANG["text_no_themes"] = "Δεν έχετε κανένα θέματα που ορίζονται. Κάντε κλικ στο κουμπί παρακάτω για να ανανεώσετε τον κατάλογο το θέμα σας, ή να ελέγξετε το <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/themes/\">έντυπο τεκμηρίωση χρήστη Εργαλεία</a> για πληροφορίες σχετικά με την προσθήκη θεμάτων.";
