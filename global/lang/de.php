...
$LANG["processing_form_incomplete"] = "Entschuldigung. Dieses Formular scheint nicht vollständig innerhalb von CloudserveForms eingerichtet worden zu sein. Die warscheinlichste Ursache dieses Problems ist, dass Sie das versteckte Formularfeld \"form_tools_initialize_form\" entfernt haben, aber nicht alle Schritte im \"Formular hinzufügen\" Vorgang durchgeführt haben. <br><br>Bitte melden Sie sich an und überprüfen Sie die Formular-Einstellungen.";
...
$LANG["processing_no_form_url_for_recaptcha"] = "CloudserveForms ist nicht in der Lage zu bestimmen, wo die Umleitung, wenn sie das CAPTCHA korrekt eingeben scheitern. Bitte leiten Sie in ein verstecktes Feld mit dem Namen <b>form_tools_form_url</b> mit der URL der Form.";
...
$LANG["text_add_form_direct_submission_drawbacks"] = "Diese Vorlage Methode ist sehr einfach zu bedienen, aber keine viel Kontrolle für kompliziertere Formen. Mehrseitige Formulare oder Formulare, die serverseitige Überprüfung erfordern, sind besser, die zweite Methode geeignet: Vorlage über die CloudserveForms API.";
...
$LANG["text_add_form_help_link"] = "Wenn Sie in irgendwelche Schwierigkeiten während dieser Schritte ausgeführt werden, versuchen Auslesen <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">Anwender-Dokumentation</a> .";
$LANG["text_add_form_step_1_text_1"] = "Die folgenden Seiten führen Sie durch die Schritte zum Konfigurieren CloudserveForms zum Anzeigen von Formularen zu speichern. Bevor Sie fortfahren, überprüfen Sie bitte, dass:";
...
$LANG["text_add_form_step_3_para_2"] = "Hinweis: Wenn Sie mehrere Werte über Checkboxen oder ein Multi-Select-Box, schicken sie sicherstellen, dass Ihre Feldnamen endet mit der []-Zeichen (siehe <a href=\"http://docs.forms.cloudservetechcentral.com/\" target=\"_blank\">Benutzer-Dokumentation</a> für weitere Informationen).";
...
$LANG["text_add_form_step_3_text_6"] = "Dadurch wird sichergestellt, werden die Daten tatsächlich in CloudserveForms gesendet. Wenn Sie durch Ihre Test-Vorlage, klicken Sie auf den Button unten setzen.";
...
$LANG["text_add_form_step_5_para_2"] = "Dann besuchen Sie &quot;Danke&quot;-Seite, an den Sitzungen leer. Sobald dies erledigt ist, werden alle neuen Formularen verarbeitet werden und durch CloudserveForms gespeichert. Versuchen Sie, eine Vorlage oder zwei, die Informationen zu überprüfen ist alles korrekt hochgeladen.";
...
$LANG["text_config_file_not_created_instructions"] = "Kopieren Sie den Inhalt aus dem folgenden Abschnitt in einer Datei namens config.php und laden Sie per FTP auf die CloudserveForms / global-Ordner (Ordner, enthält auch ein paar andere Dateien und Verzeichnisse, Datei ein library.php genannt).";
$LANG["text_confirm_delete_form"] = "Ja, ich will dieses Formular löschen";
$LANG["text_create_admin_account"] = "Jetzt werden wir an den Administrator-Konto erstellen. Dies ist für die Verwaltung aller Aspekte der CloudserveForms, wie zB das Hinzufügen von Formularen und Erstellung von Client-Konten verwendet.";
...
$LANG["text_default_file_settings_page"] = "Diese Seite definiert die Datei-Upload-Einstellungen für Ihre CloudserveForms Installation. Diese Regeln gelten für alle in CloudserveForms hochgeladenen Dateien, falls es nicht explizit für ein einzelnes Feld anders festgelegt worden ist. Hinweis: Wenn Sie den Upload-Ordner nachdem Dateien hochgeladen wurden ändern, werden sie automatisch in den neuen Ordner verschoben.";
...
$LANG["text_edit_admin_menu_page"] = "Sie können Ihr Menü Bearbeiten unten. Damit Sie jederzeit Zugriff auf alle Funktionen zur Verfügung in CloudserveForms auf den folgenden Seiten sind erforderlich: Forms, Kunden, Ihr Konto, Module, Einstellungen und Logout.";
...
$LANG["text_form_tools_login_url"] = "Die Anmelde-URL für CloudserveForms.";
...
$LANG["text_ft_installed"] = "Herzlichen Glückwunsch, wurde CloudserveForms erfolgreich installiert!";
...
$LANG["text_install_email_content_text"] = "Auf unserer Website finden Sie zahlreiche Ressourcen, die Ihnen den Einstieg erleichtern, einschließlich unserer Online-Dokumentation (https://docs.forms.cloudservetechcentral.com) und Tutorials (https://docs.forms.cloudservetechcentral.com/tutorials). Wenn Sie feststellen, dass Sie stecken bleiben oder eine Frage haben, stellen Sie eine Frage zu github (https://github.com/formtools/core/issues/).";
$LANG["text_install_form_tools_server_not_supported"] = "Sorry, Formular-Tools nicht in der Lage sein auf dem Server ausgeführt werden. <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">Bitte klicken Sie hier</a> für die Mindestanforderungen.";
$LANG["text_install_system_check"] = "Diese Seite läuft ein paar Tests auf Ihrem System zu gewährleisten, ist es in der Lage, CloudserveForms ausgeführt werden.";
...
$LANG["text_js_required"] = "Um sich bei CloudserveForms anmelden und es nutzen zu können, muss Javascript in Ihrem Browser freigegeben sein. Bitte geben Sie es nun frei und aktualisieren Sie die Ansicht.";
...
$LANG["text_log_in_to_ft"] = "Melden Sie sich in CloudserveForms";
...
$LANG["text_no_themes"] = "Sie haben noch keine Themen festgelegt. Klicken Sie auf die Schaltfläche unten, um Ihr Thema Liste zu aktualisieren, oder die <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/themes/\">Form-Werkzeuge Anwender-Dokumentation</a> für Informationen zum Hinzufügen von Themen.";
...
$LANG["validation_no_default_language"] = "Bitte selektieren Sie die Standardsprache für Ihre CloudserveForms Installation.";
...
$LANG["validation_upload_folder_not_writable"] = "Das PHP temporäre Verzeichnis ist schreibgeschützt. Bitte machen Sie das Verzeichnis beschreibbar sonst können keine Dateien von CloudserveForms (oder einem anderen Programm) hochgeladen werden. Bitte kontaktieren Sie Ihren Hostinganbieter im Falle Sie keinen Root Zugang haben.";
