...
$LANG["text_add_form_code_submission_benefits"] = "Este método usa o <a href=\"http://docs.cloudservetechcentral.com/api/\" target=\"_blank\">CloudserveForms API</a> , incluídos no principal roteiro Ferramentas formulário. A API fornece uma série de funções úteis para fazer o trabalho de integração de seu formulário com ferramentas de formulário o mais simples possível. Não há restrições à forma como o seu formulário pode ser apresentado quando você usa a API. Você pode enviar o conteúdo de uma só vez, ou página por página, você pode adicionar os seus próprios de validação do lado do servidor personalizados, imagens de CAPTCHA, você pode optar por apresentar as informações agora, mas apenas dizer-lhe para mostrar a apresentação no Formulário de Ferramentas UI em uma data posterior (veja a <a href=\"http://docs.cloudservetechcentral.com/api/?page=finalized_submissions\">Finalizado Submissões</a> seção na documentação de ajuda API).";
...
$LANG["text_add_form_help_link"] = "Se você tiver qualquer problema durante essas etapas, tente ler em <a href=\"https://docs.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">documentação do usuário</a> .";
...
$LANG["text_add_form_step_3_para_2"] = "Observação: se você está enviando vários valores através de caixas ou um multi-seleção, certifique-se de seu nome de domínio termina com a [] caracteres (consulte a <a href=\"http://docs.cloudservetechcentral.com/\" target=\"_blank\">documentação do usuário</a> para mais informações).";
...
$LANG["text_install_form_tools_server_not_supported"] = "Desculpe, Ferramentas de formulário não será capaz de rodar em seu servidor. <a href=\"https://docs.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">Por favor, clique aqui</a> para a requisitos mínimos.";
...
$LANG["text_no_themes"] = "Você não tem nenhum tema definido. Clique no botão abaixo para atualizar sua lista de tema, ou verifique a <a href=\"https://docs.cloudservetechcentral.com/userdoc/themes/\">documentação do usuário CloudserveForms</a> para obter informações sobre a adição de temas.";
