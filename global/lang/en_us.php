...
$LANG["notify_no_test_submission"] = "CloudserveForms hasn't received a successful test submission yet.";
...
$LANG["phrase_admin_panel"] = "CloudserveForms Admin Panel";
...
$LANG["phrase_ft_installation"] = "CloudserveForms Installation Script";
...
$LANG["phrase_new_ft_installation"] = "New CloudserveForms Installation";
...
$LANG["processing_form_incomplete"] = "Sorry, this form does not appear to be fully set up from within CloudserveForms. The most likely cause of this problem is that you removed the \"form_tools_initialize_form\" hidden form field, but didn't complete all the steps of the \"Add Form\" process.<br><br>Please log in and review the form configuration.";
$LANG["processing_init_complete"] = "Thank you! Your test submission has been put through successfully. Please return to the CloudserveForms Administration panel and click the \"Refresh\" button at the bottom of the Add Form Step 3 page to finish setting up your form.";
...
$LANG["processing_no_form_url_for_recaptcha"] = "CloudserveForms is unable to determine where to redirect when they fail to enter the CAPTCHA properly. Please pass in a hidden field with the name <b>form_tools_form_url</b> containing the URL of the form.";
...
$LANG["processing_no_redirect_url"] = "The submission was processed correctly, but you haven't specified a redirect URL for this form! Edit your form in the CloudserveForms UI and add the redirect URL.";
...
$LANG["text_add_form_choose_integration_method"] = "Choose which method you want to use to integrate your form with CloudserveForms.";
$LANG["text_add_form_code_submission_benefits"] = "This method uses the <a href=\"https://docs.forms.cloudservetechcentral.com/api/\" target=\"_blank\">CloudserveForms API</a>, included in the main CloudserveForms script. The API provides a number of helpful functions to make the job of integrating your form with CloudserveForms as simple as possible. There are no restrictions to how your form may be submitted when you use the API. You can submit the content in one go, or page by page; you can add your own custom server-side validation, CAPTCHA images; you can choose to submit the information now, but only tell it to display the submission in the CloudserveForms UI at a later date (see the <a href=\"https://docs.forms.cloudservetechcentral.com/api/finalized/\">Finalized Submissions</a> section in the API help documentation).";
$LANG["text_add_form_code_submission_drawbacks"] = "In order to submit your form data via PHP, your form must be located on the same website as this CloudserveForms installation. Secondly, for non-technical and novice CloudserveForms users, this method can be a little intimidating at first. But there's plenty of documentation to help you out, including two simple tutorials for integrating your single- and multi-page forms (these are linked to on a later step).";
$LANG["text_add_form_direct_submission_benefits"] = "This is the simplest way to submit your form to CloudserveForms. It doesn't require any knowledge of PHP and requires only a very small change to your form. It's great for smaller forms where you want to just submit the information to the database then redirect the user to a \"thankyou\" page.";
$LANG["text_add_form_direct_submission_drawbacks"] = "This submission method is very simple to use, but doesn't provide much control for more complicated forms. Multi-page forms or forms that require server-side validation are better suited to the second method: submitting via the CloudserveForms API.";
...
$LANG["text_add_form_help_link"] = "If you run into any trouble during these steps, try reading our <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">user documentation</a>.";
$LANG["text_add_form_step_1_text_1"] = "The following pages lead you through the steps to configure CloudserveForms to store your form submissions. Before continuing, please check that:";
...
$LANG["text_add_form_step_3_para_2"] = "Note: if you're sending multiple values via checkboxes or a multi-select box, make sure your field name ends with the [] characters (see the <a href=\"https://docs.forms.cloudservetechcentral.com/\" target=\"_blank\">user documentation</a> for more information).";
$LANG["text_add_form_step_3_text_1"] = "Here's where the fun starts! At this point, CloudserveForms is waiting for a test submission from your form. It will use this form submission to know what information should be stored in the database.";
$LANG["text_add_form_step_3_text_2"] = "by pointing your form to CloudserveForms";
$LANG["text_add_form_step_3_text_3"] = "using the CloudserveForms API";
...
$LANG["text_add_form_step_3_text_6"] = "This ensures the data is actually sent to CloudserveForms. When you have put through your test submission, click the button below.";
...
$LANG["text_add_form_step_5_para_2"] = "Then visit your \"thank you\" page to empty the sessions. Once this is done, all new form submissions will be processed and stored by CloudserveForms. Try making a submission or two to verify the information is all uploading correctly.";
...
$LANG["text_admin_email_placeholder_info"] = "This is the email address of the CloudserveForms administrator, defined in your account settings. This only outputs the email address, so if you wish to use as an HTML link, you will need to wrap it in an &lt;a&gt; tag, like so: <b>&lt;a href=\"mailto:{\$ADMINEMAIL}\"&gt;{\$ADMINEMAIL}&lt;/a&gt;</b>";
...
$LANG["text_config_file_not_created_instructions"] = "Copy and paste the contents from the section below into a file called config.php and upload it via FTP to the CloudserveForms /global folder (the folder that also contains file called library.php). Afterwards, click the button below to confirm it exists.";
$LANG["text_confirm_delete_form"] = "Yes, I want to delete this form";
$LANG["text_create_admin_account"] = "Now we're going to create the administrator's account. This is used for managing all aspects of CloudserveForms such as adding forms and creating client accounts.";
...
$LANG["text_edit_admin_menu_page"] = "You may edit your menu below. To ensure you always have access to all functionality available within CloudserveForms, the following pages are required: Forms, Clients, Your Account, Modules, Settings and Logout.";
...
$LANG["text_external_form_desc"] = "External forms are forms that already exist on your website, or somewhere on the web. Select this option if you have your own form which you'd like to integrate with CloudserveForms.";
...
$LANG["text_form_tools_login_url"] = "The login URL for CloudserveForms.";
...
$LANG["text_ft_installed"] = "Congratulations, CloudserveForms has been successfully installed!";
...
$LANG["text_install_create_config_file"] = "CloudserveForms stores your server and database settings in a file called <b>config.php</b> in your /global/ folder. Click the \"Create File\" button to automatically generate the file on your server.";
$LANG["text_install_create_database_tables"] = "Now we're going to create the CloudserveForms database tables. This step requires the database itself to already exist. If you're not sure how to create the database, please contact your hosting provider.";
...
$LANG["text_install_email_content_text"] = "There's plenty of resources on our website to help you get started, including our online documentation (https://docs.forms.cloudservetechcentral.com) and tutorials (https://docs.forms.cloudservetechcentral.com/tutorials). If you find you get stuck or have a question, ask a question on github (https://github.com/formtools/core/issues/).";
$LANG["text_install_form_tools_server_not_supported"] = "Sorry, CloudserveForms will not be able to run on your server. <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/getting_started/system_requirements/\" target=\"_blank\">Please click here</a> for the minimum requirements.";
$LANG["text_install_system_check"] = "This page runs a few tests on your system to ensure it's able to run CloudserveForms.";
...
$LANG["text_internal_form_desc"] = "Internal forms exist only within CloudserveForms - not elsewhere on your site. Only CloudserveForms user accounts will have access to the form. Select this option if you don't have an existing form.";
...
$LANG["text_js_required"] = "In order to login and use CloudserveForms, you must have javascript enabled in your browser. Please enable it now, and click refresh in your browser.";
...
$LANG["text_log_in_to_ft"] = "Log in to CloudserveForms";
...
$LANG["text_no_themes"] = "You do not have any themes defined. Click the button below to refresh your theme list, or check the <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/themes/\">CloudserveForms user documentation</a> for information about adding themes.";
...
$LANG["text_option_list_page"] = "Radio buttons, checkboxes, dropdowns and multi-select dropdown fields all provide the user with multiple options from which they can select one or more items. In CloudserveForms, these are known as Option Lists. Generally, these are created automatically by the <a href=\"{\$link}\">Add External Form</a> process, but you can manually add or edit your option lists below if your form content changes or you construct fields that are only used internally.";
...
$LANG["text_required_folders_need_write_permissions"] = "Please ensure the required folders have write permissions. After fixing the problem, click the button below to check again. See the <a href=\"https://docs.forms.cloudservetechcentral.com/installation/step2/\">help documentation</a> for further information.";
...
$LANG["text_system_check_passed"] = "Your system is able to run CloudserveForms.";
...
$LANG["text_theme_page_intro"] = "This page lists all of your themes. Click on a thumbnail to see a larger example of the theme's styles. The \"enabled\" checkbox determines whether or not that theme may be selected by clients. To browse all available themes, visit the <a href=\"https://themes.forms.cloudservetechcentral.com\" target=\"_blank\">CloudserveForms website</a>.";
...
$LANG["validation_no_default_language"] = "Please select the default language for your installation of CloudserveForms.";
...
$LANG["validation_upload_folder_not_writable"] = "This temporary upload folder specified by your PHP installation is not writable. Until this is fixed, files cannot be uploaded through CloudserveForms (or any other PHP program). Please contact your hosting provider.";
