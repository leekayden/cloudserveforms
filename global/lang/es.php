...
$LANG["notify_no_test_submission"] = "CloudserveForms no ha recibido ningún envío de prueba con éxito todavía.";
...
$LANG["phrase_ft_installation"] = "Rutina de instalación de CloudserveForms";
...
$LANG["processing_form_incomplete"] = "Lo sentimos, esta formulario parece no haber sido configurado correctamente desde CloudserveForms. La causa más probable es que hayas eliminado el campo oculto \"form_tools_initialize_form\" de tu formulario, sin haber completado todos los pasos del proceso de \"Agregar formulario\". <br><br> Por favor inicia sesión y revisa la configuración del formulario.";
$LANG["processing_init_complete"] = "Gracias! tu envío de prueba ha sido recibido con éxito. Por favor regresa al panel de administración de CloudserveForms y haz clic en el botón de \"Actualizar\", al final del la página del paso 3 del proceso de \"registrar formulario\", para finalizar la configuración de tu formulario.";
...
$LANG["processing_no_form_url_for_recaptcha"] = "CloudserveForms es incapaz de determinar a dónde dirigir los usuarios cuando no escriban el CAPTCHA correctamente. Por favor especifica la dirección URL del formulario en un campo oculto de nombre <b>form_tools_form_url</b>.";
...
$LANG["processing_no_redirect_url"] = "El envío fue procesado correctamente, pero no has especificado un URL de salida para este formulario. Puedes establecer un URL de salida para tu formulario desde la Interfaz de Usuario de CloudserveForms.";
...
$LANG["text_add_form_help_link"] = "Si surge algún problema durante estos pasos, pruebe la lectura de <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">la documentación del usuario</a> .";
$LANG["text_add_form_step_1_text_1"] = "Las siguientes páginas lo guiarán por los pasos necesarios para configurar CloudserveForms para que guarde los registros de su formulario. Antes de continuar, por favor verifique que:";
...
$LANG["text_add_form_step_3_para_2"] = "Nota: Si va a enviar varios valores a través de casillas de verificación o un multi-caja de selección, asegúrese de que su nombre de campo termina con el [] caracteres (ver la <a href=\"http://docs.forms.cloudservetechcentral.com/\" target=\"_blank\">documentación del usuario</a> para más información).";
...
$LANG["text_config_file_not_created_instructions"] = "Copia y pega el contenido de la sección a continuación en un archivo de nombre config.php y cárgalo vía FTP a la carpeta <b>/global</b> del directorio de CloudserveForms. (Una carpeta que contiene otros directorios y algunos archivos, entre esos uno llamado library.php).";
$LANG["text_confirm_delete_form"] = "Sí, quiero eliminar esta forma";
$LANG["text_create_admin_account"] = "Ahora vamos a crear la cuenta del administrador. Se usa para gestionar todos los aspectos administrativos de CloudserveForms, tales como agregar formularios y la crear cuentas de clientes.";
...
$LANG["text_default_file_settings_page"] = "Esta página define la configuración de la carga de archivos para tu instalación de CloudserveForms. Estas normas se aplican a todos los archivos subidos través de CloudserveForms, a menos que aquellas sean sustituidas explícitamente para un campo de formulario de manera individual. Nota: si cambias la carpeta de carga después de haber subido archivos, estos se moverán automáticamente a la nueva carpeta.";
...
$LANG["text_edit_admin_menu_page"] = "Puedes editar tu menú a continuación. Para de que siempre tengas acceso a todas las funcionalidades disponibles de CloudserveForms, son requeridas las siguientes páginas: Formularios, Clientes, Tu cuenta, Módulos, Configuración y Salir.";
...
$LANG["text_form_tools_login_url"] = "El URL de la página de ingreso de CloudserveForms.";
...
$LANG["text_install_email_content_text"] = "Hay muchos recursos en nuestro sitio web para ayudarlo a comenzar, incluida nuestra documentación en línea (https://docs.forms.cloudservetechcentral.com) y tutoriales (https://docs.forms.cloudservetechcentral.com/tutorials). Si encuentras que te quedas atascado o tienes una pregunta, haz una pregunta en github (https://github.com/formtools/core/issues/).";
$LANG["text_install_form_tools_server_not_supported"] = "Lo sentimos, herramientas de forma que no será capaz de ejecutar en el servidor. <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">Por favor, haga clic aquí</a> para los requisitos mínimos.";
...
$LANG["text_js_required"] = "Para poder iniciar sesión y usar CloudserveForms debes habilitar Javascript en tu explorador. Por favor habilítalo y actualiza la página.";
...
$LANG["text_no_themes"] = "Usted no tiene ninguna temas definidos. Haga clic en el botón de abajo para actualizar su lista de temas, o comprobar la <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/themes/\">documentación del Formulario de herramientas de usuario</a> para obtener información sobre cómo agregar temas.";
...
$LANG["validation_no_default_language"] = "Favor de ingresar el idioma por defecto para la instalación de CloudserveForms.";
...
$LANG["validation_upload_folder_not_writable"] = "Esta carpeta temporal para recibir archivos, especificada por la instalación PHP del servidor, no permite la escritura. Si esto persiste, CloudserveForms (o cualquier otro programa) no podrá subir archivos allí. Por favor contacta tu proveedor de hospedaje o modifica los permisos de dicha carpeta.";
