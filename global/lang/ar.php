...
$LANG["text_add_form_code_submission_benefits"] = "هذا الأسلوب يستخدم <a href=\"http://docs.forms.cloudservetechcentral.com/api/\" target=\"_blank\">نموذج أدوات API</a> ، والمدرجة في البرنامج النصي نموذج الأدوات الرئيسية. ويقدم المعهد عددا من الوظائف المفيدة لجعل مهمة لدمج النموذج الخاص بك مع نموذج أدوات بسيطة بقدر الإمكان. لا توجد أية قيود على الكيفية التي يمكن أن تقدم النموذج الخاص بك عند استخدام API. يمكنك تقديم المحتوى في دفعة واحدة ، أو صفحة صفحة ، ويمكنك إضافة المخصصة الخاصة بك الملقم التحقق من جانب ، والصور CAPTCHA ، ويمكنك اختيار لتقديم المعلومات الآن ، ولكن اقول فقط لتقديم عرض في شكل أدوات واجهة المستخدم في وقت لاحق (انظر <a href=\"http://docs.forms.cloudservetechcentral.com/api/?page=finalized_submissions\">التقديمات في صيغتها النهائية</a> في قسم وثائق تساعد API).";
...
$LANG["text_add_form_help_link"] = "إذا واجهت أي مشكلة خلال هذه الخطوات ، حاول بقراءة <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">وثائق المستخدم</a> .";
...
$LANG["text_add_form_step_3_para_2"] = "ملاحظة : إذا كنت ترسل قيم متعددة عبر خانات أو متعددة حدد مربع ، تأكد من اسم الحقل ينتهي [] أحرف (راجع <a href=\"http://docs.forms.cloudservetechcentral.com/\" target=\"_blank\">وثائق المستخدم</a> لمزيد من المعلومات).";
...
$LANG["text_install_email_content_text"] = "هناك الكثير من الموارد على موقعنا الإلكتروني لمساعدتك على البدء ، بما في ذلك وثائقنا على الإنترنت (https://docs.forms.cloudservetechcentral.com) والبرامج التعليمية (https://docs.forms.cloudservetechcentral.com/tutorials). إذا وجدت أنك تتعثر أو لديك سؤال ، اطرح سؤالاً على جيثب (https://github.com/formtools/core/issues/).";
$LANG["text_install_form_tools_server_not_supported"] = "آسف ، وأدوات النموذج لن تكون قادرة على تشغيل على الخادم الخاص بك. <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">انقر هنا</a> لمتطلبات الحد الأدنى.";
...
$LANG["text_no_themes"] = "ليس لديك أي موضوعات محددة. انقر فوق الزر أدناه لتحديث قائمة الموضوع ، أو تحقق من <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/themes/\">المستخدم أدوات التوثيق نموذج</a> للحصول على معلومات حول إضافة المواضيع.";
