...
$LANG["phrase_ft_installation"] = "CloudserveForms Installatie Script";
...
$LANG["phrase_new_ft_installation"] = "Nieuwe CloudserveForms installatie";
...
$LANG["processing_form_incomplete"] = "Sorry, dit formulier niet volledig schijnt te worden opgezet vanuit CloudserveForms. De meest waarschijnlijke oorzaak van dit probleem is dat u hebt verwijderd van de &quot;form_tools_initialize_form&quot; verborgen formulier veld, maar niet alle stappen van de &quot;Add Formulier&quot; proces. <br><br> Log in en bekijk de vorm configuratie.";
...
$LANG["text_add_form_direct_submission_benefits"] = "Dit is de eenvoudigste manier om uw formulier indienen bij CloudserveForms. Het vereist geen kennis van PHP en vereist slechts een zeer kleine verandering aan uw formulier. Het is geweldig voor kleinere formulieren waar de informatie in de database wordt opgeslagen en dan wordt de gebruiker omgeleid naar een \"dank u\" pagina.";
$LANG["text_add_form_direct_submission_drawbacks"] = "Deze toevoeging methode is zeer eenvoudig te gebruiken, maar niet voorzien van veel controle voor meer ingewikkelde formulieren. Multi-pagina formulieren of formulieren die server-side validatie vereisen zijn beter geschikt voor de tweede methode: toevoegen via het CloudserveForms API.";
...
$LANG["text_add_form_help_link"] = "Als je in de problemen tijdens deze stappen, probeer dan het uitlezen van <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">gebruikersdocumentatie</a> .";
$LANG["text_add_form_step_1_text_1"] = "De volgende pagina's leiden u stapsgewijs door de configuratie van CloudserveForms  om zo uw ingezonden formulier te bewaren. Voordat u verdergaat, controleert u dat:";
...
$LANG["text_add_form_step_3_para_2"] = "Opmerking: Als u meerdere waarden bent verzenden via keuzes of een multi-select box, zorg ervoor dat uw veld de naam eindigt op de [] tekens (de <a href=\"http://docs.forms.cloudservetechcentral.com/\" target=\"_blank\">gebruiker documentatie</a> zie voor meer informatie).";
...
$LANG["text_config_file_not_created_instructions"] = "Kopieer en plak de inhoud van de hieronder in een bestand genaamd config.php en uploaden via FTP naar de CloudserveForms / global folder (de map die ook een paar andere bestanden en directories, een bestand genaamd library.php).";
...
$LANG["text_external_form_desc"] = "Uiterlijke vormen zijn vormen die reeds bestaan ​​op uw website, of ergens op het web. Selecteer deze optie als u uw eigen formulier dat u wilt integreren met CloudserveForms.";
...
$LANG["text_form_tools_login_url"] = "De loginpgina (URL) van CloudserveForms.";
...
$LANG["text_install_email_content_text"] = "Er zijn voldoende bronnen op onze website om u op weg te helpen, inclusief onze online documentatie (https://docs.forms.cloudservetechcentral.com) en tutorials (https://docs.forms.cloudservetechcentral.com/tutorials). Als je merkt dat je vastloopt of een vraag hebt, stel een vraag op github (https://github.com/formtools/core/issues/).";
$LANG["text_install_form_tools_server_not_supported"] = "Sorry, Vorm Tools niet te kunnen draaien op je server. <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">U kunt hier klikken</a> voor de minimale vereisten.";
$LANG["text_install_system_check"] = "Deze pagina draait een paar tests op uw systeem om ervoor te zorgen dat het in staat om CloudserveForms lopen.";
...
$LANG["text_internal_form_desc"] = "Interne vormen bestaan ​​alleen in CloudserveForms - niet elders op uw site. Enige vorm Extra user accounts hebben toegang tot het formulier. Selecteer deze optie als u niet beschikt over een bestaand formulier.";
...
$LANG["text_js_required"] = "Om in te kunnen loggen en gebruik te kunnen maken van CloudserveForms dient javascript in uw browser ingeschakeld te zijn. Schakel javascript AUB in en klik \"ververs of vernieuw\" in uw browser";
...
$LANG["text_log_in_to_ft"] = "Log in om CloudserveForms";
...
$LANG["text_no_themes"] = "Je hebt geen gedefinieerd geen thema&#39;s. Klik op de onderstaande knop om uw thema lijst te vernieuwen, of kijk op de <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/themes/\">Form Extra gebruikersdocumentatie</a> voor informatie over het toevoegen van thema&#39;s.";
...
$LANG["validation_no_default_language"] = "Selecteer AUB de gewenste taal voor uw CloudserveForms installatie.";
...
$LANG["validation_upload_folder_not_writable"] = "De tijdelijke upload-map ingesteld in uw PHP instellingen is niet beschrijfbaar. Totdat dit probleem opgelost is kunnen geen bestanden worden geupload door middel van CloudserveForms (of willekeurig ander PHP programma. (neem AUB contact op met uw hosting-provider).";
