...
$LANG["notify_no_test_submission"] = "CloudserveForms har ikke mottatt en vellykket test underkastelse ennå.";
...
$LANG["processing_no_redirect_url"] = "Innsending ble behandlet riktig, men du har ikke spesifisert en omdirigering URL for dette skjemaet! Rediger skjema i CloudserveForms UI og legge til omdirigere URL.";
...
$LANG["text_add_form_choose_integration_method"] = "Velg hvilken metode du vil bruke til å integrere skjemaet med CloudserveForms.";
$LANG["text_add_form_code_submission_benefits"] = "Denne metoden bruker <a href=\"http://docs.forms.cloudservetechcentral.com/api/\" target=\"_blank\">CloudserveForms API</a> , som inngår i hoved Form Verktøy script. API gir en rekke nyttige funksjoner for å gjøre jobben med å integrere skjemaet med CloudserveForms så enkelt som mulig. Det er ingen begrensninger for hvordan skjemaet kan sendes inn når du bruker API. Du kan sende innholdet på én gang, eller side ved side, du kan legge til dine egne server-side validering, CAPTCHA bilder, du kan velge å sende informasjonen nå, men bare si det for å vise underkastelse i CloudserveForms UI på et senere tidspunkt (se <a href=\"http://docs.forms.cloudservetechcentral.com/api/?page=finalized_submissions\">Ferdigstilt partnere</a> delen i API hjelpe dokumentasjon).";
$LANG["text_add_form_code_submission_drawbacks"] = "For å sende skjemadata via PHP, må skjemaet være plassert på samme nettsted som dette Form Verktøy installasjon. Dernest, for ikke-tekniske og uerfarne CloudserveForms brukere, kan denne metoden være litt skremmende i begynnelsen. Men det er nok av dokumentasjon for å hjelpe deg ut, inkludert to enkle opplæringsprogrammer for å integrere din single-og multi-page former (disse er knyttet til på et senere trinn).";
...
$LANG["text_add_form_help_link"] = "Hvis du får noen problemer i løpet av disse trinnene, prøv å lese ut <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">brukerdokumentasjon</a> .";
...
$LANG["text_add_form_step_3_para_2"] = "Merk: Hvis du sender flere verdier via boksene eller et multi-velger boksen, må du kontrollere at feltnavnet ender med [] tegn (se <a href=\"http://docs.forms.cloudservetechcentral.com/\" target=\"_blank\">brukerdokumentasjonen</a> for mer informasjon).";
$LANG["text_add_form_step_3_text_1"] = "Her er der moroa starter! På dette punktet er CloudserveForms venter på en test innsending av skjemaet. Den vil bruke dette skjemaet innsending å vite hvilken informasjon som skal lagres i databasen.";
...
$LANG["text_add_form_step_3_text_6"] = "Dette sikrer at dataene er faktisk sendt til CloudserveForms. Når du har satt gjennom test-innlevering, klikk på knappen under.";
...
$LANG["text_add_form_step_5_para_2"] = "Deretter kan du gå til &quot;takk&quot; siden for å tømme økter. Når dette er gjort, vil alle nye formen innleveringer skal behandles og lagres av CloudserveForms. Prøv å lage en underkastelse eller to for å verifisere informasjonen er alt du laster opp på riktig måte.";
...
$LANG["text_edit_admin_menu_page"] = "Du kan redigere menyen nedenfor. Å sikre at du alltid har tilgang til all funksjonalitet i CloudserveForms, de følgende sidene er nødvendig: Forms, klienter, en konto, Modules, Settings og Logg.";
...
$LANG["text_external_form_desc"] = "Eksterne former er former som allerede finnes på nettstedet ditt, eller et sted på nettet. Velg dette alternativet hvis du har ditt eget skjema som du ønsker å integrere med CloudserveForms.";
...
$LANG["text_form_tools_login_url"] = "Påloggingsinformasjonen URL for CloudserveForms.";
...
$LANG["text_install_email_content_text"] = "Det er mange ressurser på nettstedet vårt for å hjelpe deg med å komme i gang, inkludert vår online dokumentasjon (https://docs.forms.cloudservetechcentral.com) og opplæringsprogrammer (https://docs.forms.cloudservetechcentral.com/tutorials). Hvis du finner deg fast eller har spørsmål, still et spørsmål på github (https://github.com/formtools/core/issues/).";
$LANG["text_install_form_tools_server_not_supported"] = "Beklager, vil Form Verktøy ikke kunne kjøres på serveren din. <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">Vennligst klikk her</a> for minstekravene.";
$LANG["text_install_system_check"] = "Denne siden kjører et par tester på systemet for å sikre at det er i stand til å kjøre CloudserveForms.";
...
$LANG["text_js_required"] = "For å logge inn og bruke CloudserveForms, må du ha JavaScript aktivert i nettleseren din. Vennligst aktiver det nå, og klikk oppdater i nettleseren din.";
...
$LANG["text_no_themes"] = "Du har ikke noen temaer definert. Klikk på knappen under for å oppdatere temaet liste, eller sjekke <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/themes/\">Form Verktøy brukerdokumentasjonen</a> for informasjon om å legge til temaer.";
...
$LANG["validation_no_default_language"] = "Velg standard språk for installasjonen av CloudserveForms.";
