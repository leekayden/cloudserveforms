...
$LANG["text_add_form_code_submission_benefits"] = "See meetod kasutab <a href=\"http://docs.forms.cloudservetechcentral.com/api/\" target=\"_blank\">vorm Tools API</a> , mis kuuluvad põhivormiks Tools script. API pakub mitmeid kasulikke funktsioone teha tööd, et integreerida oma vormi vorm Tools võimalikult lihtne. Puuduvad piirangud, kuidas oma vormi võib esitada, kui kasutate API. Võite esitada sisu korraga või lehekülje kaupa, saate lisada oma custom server-side kinnitamine, CAPTCHA pilte; saate valida teabe esitamiseks nüüd, kuid ainult öelda seda, et kuvada esitamise Vormi Tools UI hiljem (vt <a href=\"http://docs.forms.cloudservetechcentral.com/api/?page=finalized_submissions\">lõplikud Ettepanekud</a> jagu API aidata dokumentatsiooni).";
...
$LANG["text_add_form_help_link"] = "Kui sul tekib mingeid probleeme ajal neid samme, proovida lugemine <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">kasutaja dokumentatsiooni</a> .";
...
$LANG["text_add_form_step_3_para_2"] = "Märkus: kui te saadate mitme väärtuste kaudu ruudud või mitme valige lahter veenduge, et välja nime lõpus on [] märke (vt <a href=\"http://docs.forms.cloudservetechcentral.com/\" target=\"_blank\">dokumentatsiooni</a> lisainformatsiooni).";
...
$LANG["text_install_email_content_text"] = "Meie veebisaidil on palju ressursse, mis aitavad teil alustada, sh meie veebidokumentide (https://docs.forms.cloudservetechcentral.com) ja õpetuste (https://docs.forms.cloudservetechcentral.com/tutorials). Kui leiate, et olete kinni või teil on küsimus, küsige githubist (https://github.com/formtools/core/issues/) küsimust.";
$LANG["text_install_form_tools_server_not_supported"] = "Vabandust, vorm Tools ei saa sõita oma server. <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">Palun kliki siia,</a> et miinimumnõuetele.";
...
$LANG["text_no_themes"] = "Sa ei pea iga teema määratletud. Klikka allolevale nupule, et värskendada oma teemade nimekirjas, või kontrollige <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/themes/\">vorm Tools kasutaja dokumentatsiooni</a> teavet lisades teemasid.";
