...
$LANG["text_add_form_help_link"] = "Bu adımları sırasında herhangi bir sorun yaşarsanız, okuma deneyin <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">kullanıcı belgeleri</a> .";
...
$LANG["text_add_form_step_3_para_2"] = "Not: Eğer onay kutularını veya çok aracılığıyla alan adı [] karakterleri (Daha fazla bilgi için <a href=\"http://docs.forms.cloudservetechcentral.com/\" target=\"_blank\">kullanıcı belgelerine</a> bakın ile biter emin olun-seçin kutusunda, birden çok değer gönderiyoruz).";
...
$LANG["text_form_tools_login_url"] = "CloudserveForms giriş URL'si";
...
$LANG["text_install_email_content_text"] = "İnternet sitemizde (https://docs.forms.cloudservetechcentral.com) ve derslerimiz (https://docs.forms.cloudservetechcentral.com/tutorials) dahil olmak üzere, web sitemize başlamanıza yardımcı olacak birçok kaynak var. Eğer takılıp kaldığınızı veya bir sorunuz varsa, github (https://github.com/formtools/core/issues/) adresinden bir soru sorun.";
$LANG["text_install_form_tools_server_not_supported"] = "Üzgünüz, Form Araçları sunucu üzerinde çalıştırmak mümkün olmaz. <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">lütfen tıklayınız</a> minimum gereksinimleri için.";
...
$LANG["text_no_themes"] = "Tanımlanmış herhangi bir temalar zorunda değilsiniz. Tema listesini yenilemek ya da kontrol etmek için aşağıdaki butona <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/themes/\">Form Araçları kullanıcı belgelerine</a> ekleyerek temaları hakkında bilgi almak için tıklayın .";
