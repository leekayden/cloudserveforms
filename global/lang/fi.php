...
$LANG["notify_no_test_submission"] = "CloudserveForms ei ole vielä saanut onnistunutta testilähetystä.";
...
$LANG["text_add_form_help_link"] = "Jos olet joutunut mitään ongelmia aikana nämä vaiheet, yritä lukea ulos <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">käyttöohjeissa</a> .";
...
$LANG["text_add_form_step_3_para_2"] = "Huomaa: Jos lähetät useita arvoja kautta valintaruudut tai usean valitse valintaruutu, varmista, että kentän nimi päättyy [] merkit (ks. <a href=\"http://docs.forms.cloudservetechcentral.com/\" target=\"_blank\">käyttöohjeisiin</a> lisätietoja).";
...
$LANG["text_install_email_content_text"] = "Verkkosivustossamme on paljon resursseja, joiden avulla pääset alkuun, mukaan lukien verkko-ohjeet (https://docs.forms.cloudservetechcentral.com) ja opetusohjelmat (https://docs.forms.cloudservetechcentral.com/tutorials). Jos huomaat, että jumissa on kysymys, kysy kysymys githubista (https://github.com/formtools/core/issues/).";
$LANG["text_install_form_tools_server_not_supported"] = "Anteeksi, muoto Tools ei voi ajaa palvelimella. <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">Klikkaa tästä</a> ja vähimmäisvaatimukset.";
$LANG["text_install_system_check"] = "Tämä sivu toimii muutamia testit järjestelmän, jotta se voi suorittaa CloudserveForms.";
...
$LANG["text_no_themes"] = "Sinulla ei ole mitään teemoja määritelty. Klikkaa alla olevaa painiketta piristää teema luettelostamme, tai vilkaista <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/themes/\">muoto Työkalut käyttöohjeet</a> tietoa lisäämällä teemoista.";
