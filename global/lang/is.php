...
$LANG["text_add_form_code_submission_benefits"] = "Þessi aðferð notar <a href=\"http://docs.cloudservetechcentral.com/api/\" target=\"_blank\">CloudserveForms API</a> , í helstu CloudserveForms handriti. API afla a tala af gagnlegum aðgerðum til að gera starfið að samþætta mynd með Tools Form eins einfalt og mögulegt er. Það eru engar takmarkanir á því hvernig mynd getur skilað þegar þú notar API. Þú getur sent inn efni í einu, eða síðu með síðu, þú getur bætt við þinn eiga siðvenja framreiðslumaður-hlið löggilding, CAPTCHA myndir, þú getur valið um að senda upplýsingarnar núna, en bara segja það að sýna uppgjöf í CloudserveForms HÍ síðar (sjá <a href=\"http://docs.cloudservetechcentral.com/api/?page=finalized_submissions\">gengið Uppgjöf</a> kafla í API hjálpar gögnum).";
...
$LANG["text_add_form_help_link"] = "Ef þú keyrir inn í vandræði á þessum skrefum, reyna að lesa út <a href=\"https://docs.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">notandi heimildasöfnun</a> .";
...
$LANG["text_add_form_step_3_para_2"] = "Ath: Ef þú ætlar að senda mörg gildi um reitina eða mörgum að velja reitinn tryggja reit nafn þitt lýkur með [] stafir (sjá <a href=\"http://docs.cloudservetechcentral.com/\" target=\"_blank\">notendur gögnum</a> fyrir frekari upplýsingar).";
...
$LANG["text_install_email_content_text"] = "Það er nóg af fjármagni á heimasíðu okkar til að hjálpa þér að byrja, þ.mt online skjöl okkar (https://docs.cloudservetechcentral.com) og námskeið (https://docs.cloudservetechcentral.com/tutorials). Ef þú finnur að þú setur eða hefur spurningu skaltu spyrja spurningu um github (https://github.com/formtools/core/issues/).";
$LANG["text_install_form_tools_server_not_supported"] = "Því miður, CloudserveForms vilja ekki vera fær til að keyra á vefþjóninum þínum. <a href=\"https://docs.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">Vinsamlegast smelltu hér</a> til að lágmarkskröfur.";
...
$LANG["text_no_themes"] = "Þú ert ekki með neina þemu skilgreind. Smelltu á hnappinn hér fyrir neðan til að hressa þema listanum þínum, eða athuga <a href=\"https://docs.cloudservetechcentral.com/userdoc/themes/\">CloudserveForms notandi heimildasöfnun</a> fyrir upplýsingar um að bæta við þemu.";
