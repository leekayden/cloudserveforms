...
$LANG["notify_no_test_submission"] = "CloudserveForms hefur ekki fengið vel próf uppgjöf enn.";
...
$LANG["phrase_new_ft_installation"] = "New CloudserveForms uppsetning";
...
$LANG["processing_form_incomplete"] = "Því miður, þessi mynd virðist ekki vera að fullu komið á fót innan CloudserveForms. Líklegasta orsök af this vandamál er að þú fjarlægja the &quot;form_tools_initialize_form&quot; falinn mynd sviði, en ekki að ljúka öllum skrefum á &quot;Bæta við Form&quot; aðferð. <br><br> Skráðu þig inn og skoða mynd stillingar.";
...
$LANG["processing_no_form_url_for_recaptcha"] = "CloudserveForms er ekki að ákvarða hvar redirect þegar þeir mistakast til að slá inn Kapteinn almennilega. Vinsamlegast framhjá í falinn sviði með nafni <b>form_tools_form_url</b> sem inniheldur slóð á mynd.";
...
$LANG["text_add_form_code_submission_benefits"] = "Þessi aðferð notar <a href=\"http://docs.forms.cloudservetechcentral.com/api/\" target=\"_blank\">CloudserveForms API</a> , í helstu CloudserveForms handriti. API afla a tala af gagnlegum aðgerðum til að gera starfið að samþætta mynd með Tools Form eins einfalt og mögulegt er. Það eru engar takmarkanir á því hvernig mynd getur skilað þegar þú notar API. Þú getur sent inn efni í einu, eða síðu með síðu, þú getur bætt við þinn eiga siðvenja framreiðslumaður-hlið löggilding, CAPTCHA myndir, þú getur valið um að senda upplýsingarnar núna, en bara segja það að sýna uppgjöf í CloudserveForms HÍ síðar (sjá <a href=\"http://docs.forms.cloudservetechcentral.com/api/?page=finalized_submissions\">gengið Uppgjöf</a> kafla í API hjálpar gögnum).";
$LANG["text_add_form_code_submission_drawbacks"] = "Til að senda inn mynd gögn í gegnum PHP verður mynd þín að vera staðsett á sama vefsvæði og þetta eyðublað Verkfæri uppsetningu. Í öðru lagi, fyrir utan tæknileg og nýliði CloudserveForms notendur, þessi aðferð geta vera a lítill erfið í fyrstu. En það er nóg af gögnum til að hjálpa þér út, þar á meðal tvær einfaldar leiðbeiningar til að samþætta einstaklings-og multi-síðu gerðir þína (þau eru tengd á seinna þrep).";
$LANG["text_add_form_direct_submission_benefits"] = "Þetta er einfaldasta leiðin til að senda mynd til CloudserveForms. Það krefst ekki allir þekkingu á PHP og þurfa aðeins mjög lítill breyting á mynd þinni. Það er frábært fyrir smærri form sem þú vilt bara senda þær upplýsingar að gagnagrunninum þá utanáskrift á notandi til að &quot;thankyou&quot; síðunni.";
...
$LANG["text_add_form_help_link"] = "Ef þú keyrir inn í vandræði á þessum skrefum, reyna að lesa út <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">notandi heimildasöfnun</a> .";
...
$LANG["text_add_form_step_3_para_2"] = "Ath: Ef þú ætlar að senda mörg gildi um reitina eða mörgum að velja reitinn tryggja reit nafn þitt lýkur með [] stafir (sjá <a href=\"http://docs.forms.cloudservetechcentral.com/\" target=\"_blank\">notendur gögnum</a> fyrir frekari upplýsingar).";
$LANG["text_add_form_step_3_text_1"] = "Hér er þar sem gaman byrjar! Á þessum tímapunkti, CloudserveForms er að bíða eftir að prófa senda frá mynd þinni. Það mun nota þetta eyðublað leggja til að vita hvaða upplýsingar ættu að vera geymdar í gagnagrunni.";
$LANG["text_add_form_step_3_text_2"] = "með því að benda mynd til CloudserveForms";
...
$LANG["text_add_form_step_3_text_6"] = "Þetta tryggir að gögn er raunverulega send til CloudserveForms. Þegar þú hefur sett í uppgjöf próf skaltu smella á hnappinn hér fyrir neðan.";
...
$LANG["text_add_form_step_5_para_2"] = "Þá fara á &quot;þakka þér&quot; síðunni til að tæma fundur. Þegar þessu er lokið, mun allur nýr innsendingar mynd vera meðhöndlaðar og geymdar fyrir CloudserveForms. Reyndu að gera er að senda eða tvær til að staðfesta upplýsingar eru allar að hlaða rétt.";
...
$LANG["text_default_file_settings_page"] = "Þessari síðu skilgreinir Innhlaða stillingar þínar Form Verkfæri uppsetningu. Þessar reglur gilda um allar skrár hlaðið gegnum CloudserveForms, nema sérstaklega overridden fyrir einstaka mynd sviði. Ath: Ef þú breytir senda möppu eftir að skrá hefur verið hlaðið upp, munu þau verða sjálfkrafa færð í nýja möppu.";
...
$LANG["text_edit_admin_menu_page"] = "Þú getur breytt í valmyndinni hér fyrir neðan. Til að tryggja að alltaf hafa aðgang að öllum virkni í boði innan CloudserveForms Eftirfarandi síður eru nauðsynleg: Form, Viðskiptavinir, Reikningurinn þinn, Modules, Stillingar og Útskrá.";
...
$LANG["text_form_tools_login_url"] = "The tenging slóð fyrir CloudserveForms.";
...
$LANG["text_install_create_config_file"] = "CloudserveForms birgðir miðlara og gagnasafn stillingar í skrá sem kallast <b>config.php,</b> fundust í / á heimsvísu þinn / mappa. Smelltu á &quot;Create File&quot; hnappinn til að búa til skrána á vefþjóninum þínum.";
...
$LANG["text_install_email_content_text"] = "Það er nóg af fjármagni á heimasíðu okkar til að hjálpa þér að byrja, þ.mt online skjöl okkar (https://docs.forms.cloudservetechcentral.com) og námskeið (https://docs.forms.cloudservetechcentral.com/tutorials). Ef þú finnur að þú setur eða hefur spurningu skaltu spyrja spurningu um github (https://github.com/formtools/core/issues/).";
$LANG["text_install_form_tools_server_not_supported"] = "Því miður, CloudserveForms vilja ekki vera fær til að keyra á vefþjóninum þínum. <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">Vinsamlegast smelltu hér</a> til að lágmarkskröfur.";
$LANG["text_install_system_check"] = "Þessi síða keyrir nokkrar prófanir á kerfinu til að tryggja að það fær að hlaupa CloudserveForms.";
...
$LANG["text_no_themes"] = "Þú ert ekki með neina þemu skilgreind. Smelltu á hnappinn hér fyrir neðan til að hressa þema listanum þínum, eða athuga <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/themes/\">CloudserveForms notandi heimildasöfnun</a> fyrir upplýsingar um að bæta við þemu.";
