...
$LANG["text_add_form_help_link"] = "Si vous rencontrez un problème lors de ces étapes, essayez de lire sur <a href=\"https://docs.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">la documentation utilisateur</a> .";
...
$LANG["text_add_form_step_3_para_2"] = "Note: si vous envoyez plusieurs valeurs via des cases à cocher ou un multi-boîte de sélection, assurez-vous que votre nom de domaine se termine par le [] caractères (voir la <a href=\"http://docs.cloudservetechcentral.com/\" target=\"_blank\">documentation utilisateur</a> pour plus d'informations).";
...
$LANG["text_add_form_step_3_text_2"] = "en pointant votre formulaire CloudserveForms";
...
$LANG["text_form_tools_login_url"] = "L'URL de la connexion pour CloudserveForms.";
...
$LANG["text_install_email_content_text"] = "Notre site Web contient de nombreuses ressources pour vous aider à démarrer, notamment notre documentation en ligne (https://docs.cloudservetechcentral.com) et nos didacticiels (https://docs.cloudservetechcentral.com/tutorials). Si vous trouvez que vous êtes bloqué ou avez une question, posez une question sur github (https://github.com/formtools/core/issues/).";
$LANG["text_install_form_tools_server_not_supported"] = "Désolé, Outils de formulaire ne sera pas en mesure de s'exécuter sur votre serveur. <a href=\"https://docs.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">S'il vous plaît cliquez ici</a> pour les exigences minimales.";
...
$LANG["text_js_required"] = "Afin de vous connecter et d'utiliser CloudserveForms, vous devez avoir javascript activé dans votre navigateur. Merci de l'activer maintenant, et cliquez Actualiser dans votre navigateur.";
...
$LANG["text_log_in_to_ft"] = "Connectez-vous à CloudserveForms";
...
$LANG["text_no_themes"] = "Vous n'avez pas tous les thèmes définis. Cliquez sur le bouton ci-dessous pour vous rafraîchir la liste des thèmes, ou vérifier la <a href=\"https://docs.cloudservetechcentral.com/userdoc/themes/\">documentation de l'utilisateur former des outils</a> pour savoir comment ajouter des thèmes.";
...
$LANG["validation_no_default_language"] = "Merci d'indiquer la langue pour l'installation de CloudserveForms.";
