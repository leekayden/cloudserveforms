...
$LANG["text_add_form_help_link"] = "Ако се сблъскате с никакви проблеми по време на тези стъпки, опитайте се <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">да прочетете документацията</a> за потребителя.";
...
$LANG["text_add_form_step_3_para_2"] = "Забележка: ако сте изпращане на множество стойности чрез отметки или мулти-изберете полето, се уверете, че името на полето завършва с [] символи (виж <a href=\"http://docs.forms.cloudservetechcentral.com/\" target=\"_blank\">потребителска документация</a> за повече информация).";
...
$LANG["text_install_email_content_text"] = "На нашия уебсайт има много ресурси, които да ви помогнат да започнете, включително нашата онлайн документация (https://docs.forms.cloudservetechcentral.com) и уроци (https://docs.forms.cloudservetechcentral.com/tutorials). Ако откриете, че останахте или имахте въпрос, задайте въпрос относно github (https://github.com/formtools/core/issues/).";
$LANG["text_install_form_tools_server_not_supported"] = "Съжаляваме, Формуляр инструменти няма да бъдат в състояние да работи на вашия сървър. <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">Моля, кликнете тук</a> за минималните изисквания.";
...
$LANG["text_no_themes"] = "Вие не разполагат с никакви определени теми. Щракнете върху бутона по-долу, за да опресни списъка си тема, <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/themes/\">или проверете документацията за потребителя</a> Форма Инструменти за информация относно добавянето на теми.";
