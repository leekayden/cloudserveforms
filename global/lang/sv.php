...
$LANG["text_add_form_help_link"] = "Om du stöter på några problem under dessa steg, läs gärna vår <a href=\"https://docs.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">användardokumentation</a> .";
...
$LANG["text_add_form_step_3_para_2"] = "VIKTIGT: om du skickar in flervalsalternativ via kryssrutor eller en flervalsruta bör du kontrollera att fältnamnet slutar med tecknen [] (se <a href=\"http://docs.cloudservetechcentral.com/\" target=\"_blank\">användardokumentationen</a> för mer information).";
...
$LANG["text_install_email_content_text"] = "Det finns många resurser på vår hemsida för att hjälpa dig att komma igång, inklusive vår online dokumentation (https://docs.cloudservetechcentral.com) och handledning (https://docs.cloudservetechcentral.com/tutorials). Om du tycker att du fastnar eller har en fråga, ställ en fråga på github (https://github.com/formtools/core/issues/).";
$LANG["text_install_form_tools_server_not_supported"] = "Tyvärr så kommer inte CloudserveForms att kunna köras på din server. <a href=\"https://docs.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">Läs om minimikraven här</a>.";
...
$LANG["text_no_themes"] = "Du har inga definierade teman. Klicka på knappen nedan för att uppdatera din temalista eller läs mer i <a href=\"https://docs.cloudservetechcentral.com/userdoc/themes/\">CloudserveForms användardokumentation</a> kring hur du gör för att lägga till teman.";
