...
$LANG["notify_no_test_submission"] = "CloudserveForms har ännu inte tagit emot något lyckat testinskick.";
...
$LANG["phrase_ft_installation"] = "CloudserveForms installationsscript";
...
$LANG["phrase_new_ft_installation"] = "Ny installation av CloudserveForms";
...
$LANG["processing_form_incomplete"] = "Tyvärr så verkar inte detta formulär vara helt och hållet inställt inifrån CloudserveForms. Troligtvis beror detta på att du tagit bort det gömda formulärfältet \"form_tools_initialize_form\" från webbsidans formulärkod, men utan att fullfölja alla stegen i processen \"Lägg till formulär\". <br /><br />Logga in igen och granska formulärets konfiguration.";
$LANG["processing_init_complete"] = "Tack! Ditt testinskick har passerat igenom systemet som det ska. Gå nu tillbaka till CloudserveForms administrationspanel och klicka på knappen \"Ladda om\" på sidan Lägg till formulär, steg 3, för att färdigställa inställningen av ditt formulär.";
...
$LANG["processing_no_form_url_for_recaptcha"] = "CloudserveForms kan inte bestämma vart den ska omdirigera när ett misslyckat försök att ange CAPTCHA sker. Du behöver lägga till ett gömt (hidden) fält med namnet <strong>form_tools_form_url</strong> som innehåller URL till formuläret.";
...
$LANG["processing_no_redirect_url"] = "Inskicket processades som det skulle men du har inte angett ett omdirigerings-URL för formuläret! Ändra ditt formulär i CloudserveForms gränssnitt och lägg till en omdirigeringsadress.";
...
$LANG["text_add_form_choose_integration_method"] = "Välj vilken metod du vill använda för att integrera ditt formulär med CloudserveForms.";
$LANG["text_add_form_code_submission_benefits"] = "Denna metod använder <a href=\"http://docs.forms.cloudservetechcentral.com/api/\" target=\"_blank\">CloudserveForms API</a> , som ingår i CloudserveForms huvudscript. APIn ger tillgång till ett antal användbara funktioner som gör jobbet med att integrera ditt formulär med CloudserveForms så enkelt som möjligt. Det finns inga begränsningar för hur formuläret kan skickas in när du använder API:et. Du kan skicka in innehållet på en gång, eller sida för sida, du kan lägga till dina egna server-side valideringar, CAPTCHA-bilder, du kan välja att skicka in information nu, men bara visa den i CloudserveForms användargränssnitt vid en senare tidpunkt (se avsnittet<a href=\"http://docs.forms.cloudservetechcentral.com/api/?page=finalized_submissions\">Finalized Submissions</a> i API-hjälpdokumentation).";
$LANG["text_add_form_code_submission_drawbacks"] = "För att skicka in din formulärdata via PHP, måste formuläret finnas på samma webbplats som denna CloudserveForms installation. För icke-tekniska och oerfarna CloudserveForms-användare, kan denna metod vara lite skrämmande i början. Men det finns gott om dokumentation för att hjälpa dig, inklusive två enkla steg-för-steg-beskrivningar för att integrera dina en-och flersidiga formulär (dessa kopplas på i ett senare skede).";
$LANG["text_add_form_direct_submission_benefits"] = "Det här är det enklaste sättet att skicka in dina formulärdata till CloudserveForms. Det kräver ingen förkunskap om PHP och innebär bara en väldigt liten förändring i din formulärkod. Det passar utmärkt för mindre formulär där du bara vill att besökaren ska skicka in sina data till databasen och därefter slussas vidare till en tacksida.";
$LANG["text_add_form_direct_submission_drawbacks"] = "Denna inskickningsmetod är väldigt enkel att använda men ger inte mycket kontroll för mer komplicerade formulär. Formulär som sträcker sig över flera sidor eller som kräver serverbaserad validering passar bättre med den andra metoden: att skicka formulären via CloudserveForms API.";
...
$LANG["text_add_form_help_link"] = "Om du stöter på några problem under dessa steg, läs gärna vår <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">användardokumentation</a> .";
$LANG["text_add_form_step_1_text_1"] = "De följande sidorna guidar dig genom de olika stegen som krävs för att ställa in CloudserveForms så att det lagrar dina formulärinskick på rätt sätt. Innan du börjar, försäkra dig om att:";
...
$LANG["text_add_form_step_3_para_2"] = "VIKTIGT: om du skickar in flervalsalternativ via kryssrutor eller en flervalsruta bör du kontrollera att fältnamnet slutar med tecknen [] (se <a href=\"http://docs.forms.cloudservetechcentral.com/\" target=\"_blank\">användardokumentationen</a> för mer information).";
$LANG["text_add_form_step_3_text_1"] = "Det är nu det roliga börjar! Just nu väntar CloudserveForms på ett testinskick från ditt formulär. Det kommer att använda detta formulärinskick för att lära sig vilken information som ska lagras i databasen.";
$LANG["text_add_form_step_3_text_2"] = "genom att peka ditt formulär till CloudserveForms";
$LANG["text_add_form_step_3_text_3"] = "använda dig av CloudserveForms API";
...
$LANG["text_add_form_step_3_text_6"] = "Detta försäkrar att data verkligen skickas vidare till CloudserveForms. När du har skickat igenom ditt testinskick så klickar du på knappen nedan.";
...
$LANG["text_add_form_step_5_para_2"] = "Gå därefter till din \"tacksida\" för att tömma sessionen. När detta väl är gjort så kommer alla nya formulärinskick att processas och lagras av CloudserveForms. Testa ett par inskick för att försäkra dig om att allt fungerar som det ska.";
...
$LANG["text_admin_email_placeholder_info"] = "Detta är e-postadressen till CloudserveForms administratör som definierats i kontoinställningarna. E-postadressen visas bara som text så om du vill göra en HTML-länk av den behöver du baka in den i en <a>-tagg på det här viset:<br /><strong>&lt;a href=\"mailto:{\$ADMINEMAIL}\"&gt;{\$ADMINEMAIL}&lt;/a&gt;</strong>";
...
$LANG["text_config_file_not_created_instructions"] = "Kopiera och klistra in innehållet från nedanstående text i en ny fil som du döper till config.php. Ladda sedan upp den via FTP till din installation av CloudserveForms, katalogen /global (den katalogen innehåller också några andra filer och underkataloger samt library.php).";
$LANG["text_confirm_delete_form"] = "Ja, jag vill ta bort detta formulär";
$LANG["text_create_admin_account"] = "Nu ska vi skapa administratörskontot. Det används för att hantera ALLA aspekter av CloudserveForms som t ex att lägga till formulär och skapa klientkonton.";
...
$LANG["text_default_file_settings_page"] = "Den här sidan definierar inställningarna för filuppladdning i din CloudserveForms installation. Dessa regler gäller för alla filer som laddas upp genom CloudserveForms om du inte explicit har undantagit ett speciellt formulärfält någonstans. Observera att om du ändrar uppladdningskatalog efter det att filer har börjat laddas upp så kommer de filerna automatiskt att flyttas till den nya katalogen.";
...
$LANG["text_edit_admin_menu_page"] = "Du kan ändra din meny här nedan. För att försäkra dig om att du alltid har åtkomst till tillgänglig funktionalitet inom CloudserveForms så behövs följande sidori din meny: Formulär, Klienter, Ditt konto, Moduler, Inställningar och Logga ut.";
...
$LANG["text_external_form_desc"] = "Externa formulär är formulär som redan finns på din webbplats, eller någon annanstans på webben. Välj detta alternativ om du har ett eget formulär som du vill integrera med CloudserveForms.";
...
$LANG["text_form_tools_login_url"] = "URL för inloggning till CloudserveForms";
...
$LANG["text_ft_installed"] = "Gratulerar! CloudserveForms har nu installerats.";
...
$LANG["text_install_create_config_file"] = "CloudserveForms lagrar dina server- och databasinställningar i en fil kallad <strong>config.php</strong> som du hittar i katalogen /global/. Klicka på knappen \"Skapa fil\" för att automatiskt skapa denna fil på din server.";
$LANG["text_install_create_database_tables"] = "Nu ska vi skapa CloudserveForms databastabeller. Detta steg kräver att databasen i sig redan är skapad. Om du inte är säker på hur du ska göra detta, kontakta din webbplatsleverantör.";
...
$LANG["text_install_email_content_text"] = "Det finns många resurser på vår hemsida för att hjälpa dig att komma igång, inklusive vår online dokumentation (https://docs.forms.cloudservetechcentral.com) och handledning (https://docs.forms.cloudservetechcentral.com/tutorials). Om du tycker att du fastnar eller har en fråga, ställ en fråga på github (https://github.com/formtools/core/issues/).";
$LANG["text_install_form_tools_server_not_supported"] = "Tyvärr så kommer inte CloudserveForms att kunna köras på din server. <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">Läs om minimikraven här</a>.";
$LANG["text_install_system_check"] = "Den här sidan kör några tester av ditt system för att försäkra att det kan använda sig av CloudserveForms.";
...
$LANG["text_internal_form_desc"] = "Interna formulär existerar endast inom CloudserveForms - inte någon annanstans på din webbplats. Endast CloudserveForms användarkonton kommer att ha tillgång till formuläret. Välj detta alternativ om du inte har ett befintligt formulär.";
...
$LANG["text_js_required"] = "För att du ska kunna logga in och använda CloudserveForms måste du ha aktiverat tillåtelse att köra Javascript i din webbläsare. Aktivera det nu och ladda sedan om denna sidan.";
...
$LANG["text_log_in_to_ft"] = "Logga in till CloudserveForms";
...
$LANG["text_no_themes"] = "Du har inga definierade teman. Klicka på knappen nedan för att uppdatera din temalista eller läs mer i <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/themes/\">CloudserveForms användardokumentation</a> kring hur du gör för att lägga till teman.";
...
$LANG["validation_no_default_language"] = "Välj förvalt språk för din installation av CloudserveForms.";
...
$LANG["validation_upload_folder_not_writable"] = "Denna tillfälliga uppladdningskatalog som specificerats av din PHP-installation är inte skrivbar. Tills dess att detta problem fixats så kan inte filer laddas upp via CloudserveForms (eller något annat PHP-program heller för den delen). Kontakta din webbplatsvärd.";
