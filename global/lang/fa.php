...
$LANG["text_add_form_help_link"] = "اگر شما را به هر گونه مشکل در طی این مراحل اجرا ، سعی کنید <a href=\"https://docs.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">به خواندن</a> مستندات کاربر.";
...
$LANG["text_add_form_step_3_para_2"] = "توجه : اگر شما ارزش های چند گانه از طریق ارسال چک باکس ها و یا چند جعبه را انتخاب کنید ، مطمئن شوید که زمینه نام خود را به پایان می رسد با [] نویسه (نگاه کنید به <a href=\"http://docs.cloudservetechcentral.com/\" target=\"_blank\">اسناد کاربر</a> برای اطلاعات بیشتر).";
...
$LANG["text_install_email_content_text"] = "منابع زیادی در وب سایت ما برای کمک به شما برای شروع کار، از جمله مستندات آنلاین ما (https://docs.cloudservetechcentral.com) و آموزش (https://docs.cloudservetechcentral.com/tutorials) وجود دارد. اگر متوجه شدید که گیر کرده یا سوال دارید، از github سوال کنید (https://github.com/formtools/core/issues/).";
$LANG["text_install_form_tools_server_not_supported"] = "با عرض پوزش ، ابزار فرم خواهد شد قادر به بر روی سرور خود اجرا <a href=\"https://docs.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">کنید ، لطفا اینجا را</a> کلیک کنید برای حداقل مورد نیاز.";
...
$LANG["text_no_themes"] = "انجام هر گونه تم های تعریف شده نیست. به روز کردن لیست موضوع خود را چک کرده و <a href=\"https://docs.cloudservetechcentral.com/userdoc/themes/\">یا ابزار فرم مستندات کاربر</a> برای کسب اطلاعات در مورد اضافه کردن تم روی دکمه زیر کلیک کنید.";
