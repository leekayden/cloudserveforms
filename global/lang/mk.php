...
$LANG["processing_form_incomplete"] = "За жал, овој образец не се појавува целосно да се воспостави во рок од CloudserveForms. Најверојатно причина за овој проблем е во тоа што сте отстранети од &quot;form_tools_initialize_form&quot; скриена форма поле, но не комплетно сите чекори на &quot;Додади Образец&quot; процес. <br><br> Ве молиме да се логирате и преглед форма конфигурација.";
...
$LANG["text_add_form_direct_submission_benefits"] = "Ова е наједноставен начин да ја поднесете вашата форма за да CloudserveForms. Тоа не бара никакви познавање на PHP и бара само една мала промена на вашата форма. Таа е одлична за помали форми каде сакате само да ги достави информации за базата на податоци потоа се пренасочи на корисникот на &quot;thankyou&quot; страница.";
...
$LANG["text_add_form_help_link"] = "Ако наидете на никакви проблеми за време на овие чекори, обидете се читање на <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">корисникот документација</a> .";
...
$LANG["text_add_form_step_3_para_2"] = "Забелешка: ако праќаш повеќе вредности преку обележувачи или мулти-избери кутија, бидете сигурни дека вашата област име завршува со [] ликови (види на <a href=\"http://docs.forms.cloudservetechcentral.com/\" target=\"_blank\">корисник документација</a> за повеќе информации).";
...
$LANG["text_add_form_step_3_text_6"] = "Ова обезбедува податоците е всушност праќаат до CloudserveForms. Кога ќе се постави во текот на пробната поднесување, кликнете на копчето подолу.";
...
$LANG["text_add_form_step_5_para_2"] = "Потоа посета на својата &quot;благодарам&quot; за да го испразните сесии. Откако ова е направено, сите поднесоци нова форма ќе бидат обработени и зачувани од страна CloudserveForms. Обидете се да направите поднесување или две за да ја потврди оваа информација се сите Неуспешно правилно.";
...
$LANG["text_default_file_settings_page"] = "Оваа страница ја дефинира Подигни датотека за вашата конфигурација Образец Алатник инсталација. Овие правила важат за сите датотеки качен преку CloudserveForms, освен ако експлицитно overridden за одделен вид терен. Забелешка: Ако промена на фолдерот испратите по датотеки се подигнати, тие ќе бидат автоматски преместена во новата папка.";
...
$LANG["text_form_tools_login_url"] = "Влезот на URL-то за CloudserveForms.";
...
$LANG["text_ft_installed"] = "Честитки, CloudserveForms е успешно инсталиран!";
...
$LANG["text_install_email_content_text"] = "Има многу ресурси на нашата веб-страница за да ви помогнеме да започнете, вклучувајќи ја нашата онлајн документација (https://docs.forms.cloudservetechcentral.com) и вежби (https://docs.forms.cloudservetechcentral.com/tutorials). Ако најдете дека сте заглавени или имате прашање, поставете прашање за github (https://github.com/formtools/core/issues/).";
$LANG["text_install_form_tools_server_not_supported"] = "За жал, формата Алатки не ќе можат да работат на вашиот сервер. <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">Ве молиме кликнете овде</a> за минималните барања.";
$LANG["text_install_system_check"] = "Оваа страница трае неколку тестови на вашиот систем, да се осигура дека може да ги стартувате CloudserveForms.";
...
$LANG["text_no_themes"] = "Вие не имате било какви теми дефинирани. Кликнете на копчето подолу за да го освежи вашата тема листа, или проверка на <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/themes/\">формата Алатки корисник документација</a> за информации за додавање на теми.";
