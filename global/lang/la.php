...
$LANG["notify_no_test_submission"] = "CloudserveForms nav saņēmusi Veiksmīgs tests iesniegšanas yet.";
...
$LANG["phrase_new_ft_installation"] = "New CloudserveForms uzstādīšana";
...
$LANG["processing_form_incomplete"] = "Atvainojiet, šo veidlapu nešķiet pilnībā izveidot no iekšpuses CloudserveForms. Visdrīzāk iemesls šī problēma ir tā, ka tu noņem &quot;form_tools_initialize_form&quot; slēptās formas laukā, bet nebija pilnīgi visu posmiem &quot;Pievienot Forma&quot; procesu. <br><br> Lūdzu, piesakieties un pārskata veidlapu konfigurāciju.";
$LANG["processing_init_complete"] = "Paldies! Jūsu pārbaudes iesniegums ir nodots cauri veiksmīgi. Lūdzu, atgriezieties CloudserveForms Administrācijas panelis un noklikšķiniet uz &quot;Atsvaidzināt&quot; pogas apakšā Pievienot Form Step 3 lapu, lai pabeigtu izveidot savu formu.";
...
$LANG["text_add_form_code_submission_benefits"] = "Šī metode izmanto <a href=\"http://docs.forms.cloudservetechcentral.com/api/\" target=\"_blank\">veidlapu Tools API</a> , kas iekļauta galvenā forma Tools skriptu. API nodrošina vairākas noderīgas funkcijas, lai padarītu darbu integrēt jūsu veidlapas ar CloudserveForms tik vienkāršu, cik iespējams. Nav nekādu ierobežojumu, kā jūsu veidlapu var iesniegt, ja jūs izmantojat API. Jūs varat iesniegt saturu vienā piegājienā, vai lapu pēc lapas, jūs varat pievienot savu pielāgoto servera puses validāciju, CAPTCHA attēlu, varat izvēlēties iesniegt informāciju tagad, bet tikai pateikt to, lai parādītu iesnieguma veidlapas Tools UI vēlāk (sk. <a href=\"http://docs.forms.cloudservetechcentral.com/api/?page=finalized_submissions\">pabeigts Iesniegumi</a> sadaļu API palīdzības dokumentācija).";
$LANG["text_add_form_code_submission_drawbacks"] = "Lai iesniegtu veidlapas datus, izmantojot PHP, veidlapas jāatrodas tajā pašā tīmekļa vietnē, kā šīs formas Tools uzstādīšanu. Otrkārt, nav tehnisks, un iesācēju CloudserveForms lietotājiem, šo metodi var nedaudz iebiedēt sākumā. Bet tur ir daudz dokumentāciju, lai palīdzētu jums, kas, ieskaitot divus vienkāršus konsultācijas par integrēt jūsu vienu un vairāku lapu veidlapas (tās ir saistītas ar vēlāku pasākumu).";
...
$LANG["text_add_form_help_link"] = "Ja jūs satikt nepatikšanas laikā šiem soļiem, izmēģiniet nolasīt <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">lietotāja dokumentāciju</a> .";
...
$LANG["text_add_form_step_3_para_2"] = "Piezīme: ja jūs sūtāt vairākas vērtības, izmantojot izvēles rūtiņas, vai vairāku atlasītu kaste, pārliecinieties, vai lauka nosaukums beidzas ar [] rakstzīmes (skatīt <a href=\"http://docs.forms.cloudservetechcentral.com/\" target=\"_blank\">lietotāja dokumentācijai</a> vairāk informāciju).";
...
$LANG["text_add_form_step_3_text_2"] = ", norādot savu formu CloudserveForms";
...
$LANG["text_admin_email_placeholder_info"] = "Šī ir e-pasta adrese CloudserveForms administratora definēts jūsu konta iestatījumus. Tas tikai Rezultātu e-pasta adresi, tādēļ, ja jūs vēlaties izmantot kā HTML saiti, jums būs nepieciešams wrap to &lt;a&gt; tag, piemēram, tā: <br /> <b>&lt;a href=&quot;mailto:{\$ADMINEMAIL}&quot;&gt; (\$ ADMINEMAIL) &lt;/ a&gt;</b>";
...
$LANG["text_config_file_not_created_instructions"] = "Nokopējiet un ielīmējiet saturu no iedaļā stājas failu ar nosaukumu config.php un augšupielādēt to, izmantojot FTP CloudserveForms / pasaules mapi (mape, kas satur arī dažus citus failus un direktorijas, vienu failu ar nosaukumu library.php).";
...
$LANG["text_default_file_settings_page"] = "Šī lapa nosaka failu augšupielāde iestatījumus CloudserveForms uzstādīšana. Šie noteikumi attiecas uz visām faili augšupielādēti caur CloudserveForms, ja nav skaidri ignorē par atsevišķu veidlapu jomā. Piezīme: ja maināt upload mape pēc faili ir augšupielādēts, tie tiks automātiski pārvietota uz jaunu mapi.";
...
$LANG["text_external_form_desc"] = "Ārējās formas ir formas, kas jau eksistē jūsu mājas lapā, vai kaut kur internetā. Atlasiet šo opciju, ja jums ir jūsu pašu veidlapu, kuru vēlaties, lai integrētu ar CloudserveForms.";
...
$LANG["text_form_tools_login_url"] = "Login URL CloudserveForms.";
...
$LANG["text_install_create_config_file"] = "CloudserveForms veikali Jūsu servera un datu bāzes iestatījumus failu ar nosaukumu <b>config.php</b> atrodamas jūsu / pasaules / mapi. Noklikšķiniet uz &quot;Izveidot File&quot; pogu, lai automātiski ģenerētu failu servera.";
$LANG["text_install_create_database_tables"] = "Tagad mēs spēsim radīt CloudserveForms datu bāzes tabulām. Šis solis nepieciešams datubāzē sevi jau ir izveidoti. Ja neesat pārliecināts, kā to izdarīt, lūdzu, sazinieties ar jūsu hostinga sniedzēju.";
...
$LANG["text_install_email_content_text"] = "Mūsu vietnē ir daudz resursu, lai palīdzētu jums sākt darbu, tostarp mūsu tiešsaistes dokumentāciju (https://docs.forms.cloudservetechcentral.com) un apmācības (https://docs.forms.cloudservetechcentral.com/tutorials). Ja konstatējat, ka jums ir iestrēdzis vai jums rodas jautājums, uzdodiet jautājumu par github (https://github.com/formtools/core/issues/).";
$LANG["text_install_form_tools_server_not_supported"] = "Atvainojiet, forma Tools nevarēs palaist uz jūsu servera. <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">Lūdzu, klikšķiniet šeit</a> , lai minimālās prasības.";
$LANG["text_install_system_check"] = "Šī lapa darbojas daži testi Jūsu sistēmu, lai nodrošinātu, ka tas ir spējīgs darboties CloudserveForms.";
...
$LANG["text_internal_form_desc"] = "Iekšējā veidlapas pastāv tikai forma Tools - citur jūsu vietnē. Tikai CloudserveForms lietotāju kontiem būs piekļuve formā. Atlasiet šo opciju, ja jums nav esošo formu.";
...
$LANG["text_no_themes"] = "Jums nav neviena definēti motīvi. Noklikšķiniet pogu zemāk, lai atsvaidzinātu jūsu tēmu saraksts, vai pārbaudīt <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/themes/\">CloudserveForms lietotāja dokumentācijā</a> informāciju par pievienojot tēmām.";
...
$LANG["validation_no_default_language"] = "Lūdzu, izvēlieties noklusēto valodu instalācijas CloudserveForms.";
...
$LANG["validation_upload_folder_not_writable"] = "Šī pagaidu upload mape norādījis Jūsu PHP uzstādīšana nav rakstāms. Līdz brīdim, kad tas ir noteikts, failus nevar augšupielādēti caur CloudserveForms (vai jebkuru citu PHP programmā). Lūdzu, sazinieties ar hostinga sniedzēju.";
