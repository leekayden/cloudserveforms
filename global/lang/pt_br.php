...
$LANG["phrase_ft_installation"] = "Script de instalação do CloudserveForms";
...
$LANG["phrase_new_ft_installation"] = "Nova instalação do CloudserveForms";
...
$LANG["text_add_form_step_1_text_1"] = "As páginas seguintes levarão você através dos passos para configurar o CloudserveForms para armazenar suas submissões do formulário. Antes de continuar, verifique se:";
...
$LANG["text_add_form_step_3_text_2"] = "apontando seu formulário para o CloudserveForms";
$LANG["text_add_form_step_3_text_3"] = "usando a API do CloudserveForms";
...
$LANG["text_add_form_step_3_text_6"] = "Isto assegura que os dados estão sendo enviados para o CloudserveForms. Quando você acabar de enviar seu formulário, clique no botão abaixo.";
...
$LANG["text_add_form_step_5_para_2"] = "Então visite o seu \"agradecimento\" para esvaziar as sessões. Quando isso for feito, todas as submissões novo formulário serão processados e armazenados pelo CloudserveForms. Tente fazer uma apresentação ou duas para verificar se as informações foram inseridas corretamente.";
...
$LANG["text_config_file_not_created_instructions"] = "Copie e cole o conteúdo da seção abaixo em um arquivo chamado config.php. Faça o upload via FTP para a pasta global folder dentro de sua instalação do CloudserveForms (esta pasta também contém alguns outros arquivos e diretórios, um deles chamado library.php).";
$LANG["text_confirm_delete_form"] = "Sim, eu quero excluir este formulário";
$LANG["text_create_admin_account"] = "Agora será criada a conta de administrador. Ela é usada para gerenciar todos os aspectos do CloudserveForms, como adicionar formulários e criar contas de usuários.";
...
$LANG["text_default_file_settings_page"] = "Esta página define as opções de envio de arquivos de sua instalação do CloudserveForms. As regras se aplicam a todos os arquivos enviados através do CloudserveForms, exceto quando modificadas para um campo de formulário individual. Nota: se você mudar a pasta de envio depois de ter enviado arquivos, eles serão automaticamente movidos para a nova pasta.";
...
$LANG["validation_no_default_language"] = "Selecione o idioma padrão para sua instalação do CloudserveForms.";
