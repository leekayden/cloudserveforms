...
$LANG["text_add_form_help_link"] = "Jika Anda mengalami masalah apapun selama langkah ini, cobalah membaca keluar <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">dokumentasi pengguna</a> .";
...
$LANG["text_add_form_step_3_para_2"] = "Catatan: jika Anda mengirim beberapa nilai melalui kotak centang atau multi-pilih kotak, pastikan nama field berakhir dengan [] karakter (lihat <a href=\"http://docs.forms.cloudservetechcentral.com/\" target=\"_blank\">dokumentasi pengguna</a> untuk informasi lebih lanjut).";
...
$LANG["text_default_file_settings_page"] = "Halaman ini mendefinisikan pengaturan upload file untuk Formulir Peralatan instalasi. Aturan-aturan ini berlaku untuk semua file di-upload melalui CloudserveForms, kecuali secara eksplisit ditolak untuk setiap bidang bentuk. Catatan: jika Anda mengubah folder upload setelah file sudah di-upload, mereka akan dipindahkan secara otomatis ke folder baru.";
...
$LANG["text_install_email_content_text"] = "Ada banyak sumber daya di situs web kami untuk membantu Anda memulai, termasuk dokumentasi online kami (https://docs.forms.cloudservetechcentral.com) dan tutorial (https://docs.forms.cloudservetechcentral.com/tutorials). Jika Anda menemukan Anda terjebak atau memiliki pertanyaan, ajukan pertanyaan di github (https://github.com/formtools/core/issues/).";
$LANG["text_install_form_tools_server_not_supported"] = "Maaf, Alat Formulir tidak akan dapat menjalankan pada server Anda. <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">Silahkan klik di sini</a> untuk persyaratan minimum.";
...
$LANG["text_no_themes"] = "Anda tidak memiliki tema yang ditetapkan. Klik tombol di bawah ini untuk menyegarkan daftar tema Anda, atau periksa <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/themes/\">Formulir Alat dokumentasi pengguna</a> untuk informasi tentang menambahkan tema.";
