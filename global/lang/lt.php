...
$LANG["text_add_form_code_submission_benefits"] = "Šis metodas naudoja <a href=\"http://docs.forms.cloudservetechcentral.com/api/\" target=\"_blank\">forma Įrankiai API</a> , pagrindinės formos Įrankiai scenarijų. API &quot;suteikia daug naudingų funkcijų darbą įtraukti savo formą su forma Įrankiai, kaip paprasta, kaip įmanoma. Nėra jokių apribojimų, kaip savo forma gali būti pateikta, kai jūs naudojate API. Galite pateikti vienu ypu, ar puslapis po puslapio turinį, galite pridėti savo serverio pusėje patvirtinimo, CAPTCHA vaizdus galite pasirinkti pateikti informaciją, tačiau tik pasakyti, parodyti pateikimo formos Įrankiai UI vėliau (žr. skyriuje <a href=\"http://docs.forms.cloudservetechcentral.com/api/?page=finalized_submissions\">baigtas Pristatymai</a> API pagalbos dokumentacija).";
...
$LANG["text_add_form_help_link"] = "Jei paleisti į kokių nors problemų, per šiuos veiksmus, bandykite <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">skaityti vartotojo</a> dokumentacijoje .";
...
$LANG["text_add_form_step_3_para_2"] = "Pastaba: Jei jūs siunčiate keletą reikšmių naudojant vėliavėles ar multi-pasirinkite langelį, įsitikinkite, kad lauko pavadinimą baigiasi [] ženklų (žr. <a href=\"http://docs.forms.cloudservetechcentral.com/\" target=\"_blank\">vartotojo dokumentaciją</a> daugiau informacijos).";
...
$LANG["text_install_email_content_text"] = "Mūsų svetainėje yra daug išteklių, kad padėtų jums pradėti, įskaitant mūsų internetinę dokumentaciją (https://docs.forms.cloudservetechcentral.com) ir vadovėlius (https://docs.forms.cloudservetechcentral.com/tutorials). Jei pastebėjote, kad įstrigo arba turite klausimą, paklauskite apie \"github\" (https://github.com/formtools/core/issues/).";
$LANG["text_install_form_tools_server_not_supported"] = "Atsiprašome, įrankiai gali paleisti savo serverį. <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">Prašome spausti čia,</a> minimalius reikalavimus.";
...
$LANG["text_no_themes"] = "Jūs neturite jokių temų apibrėžta. Paspauskite mygtuką žemiau, norėdami atnaujinti savo temą sąrašo arba patikrinti informaciją apie tai, kaip pridėti temas <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/themes/\">forma Įrankiai vartotojo dokumentaciją</a> .";
