...
$LANG["text_add_form_step_3_para_2"] = "Note: if you're sending multiple values via checkboxes or a multi-select box, make sure your field name ends with the [] characters (see the <a href=\"http://docs.forms.cloudservetechcentral.com/\" target=\"_blank\">user documentation</a> for more information).";
...
$LANG["text_config_file_not_created_instructions"] = "Copy and paste the contents from the section below into a file called config.php and upload it via FTP to the CloudserveForms /global folder (the folder that also contains a few other files and directories, one file called library.php).";
...
$LANG["text_install_create_config_file"] = "CloudserveForms stores your server and database settings in a file called <b>config.php</b>, found in your /global/ folder. Click the \"Create File\" button to automatically generate the file on your server.";
$LANG["text_install_create_database_tables"] = "Now we're going to create the CloudserveForms database tables. This step requires the database itself to have already been created. If you're not sure how to do this, please contact your hosting provider.";
...
$LANG["text_install_email_content_text"] = "Bizim onlayn sənədlərimiz (https://docs.forms.cloudservetechcentral.com) və təlimlər (https://docs.forms.cloudservetechcentral.com/tutorials) daxil olmaqla, başlamanıza kömək etmək üçün veb səhifəmizdə çoxlu resurs var. Sıkıştığınız və ya bir sualınız varsa, github (https://github.com/formtools/core/issues/) haqqında bir sual soruşun.";
$LANG["text_install_form_tools_server_not_supported"] = "Sorry, CloudserveForms will not be able to run on your server. <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">Please click here</a> for the minimum requirements.";
