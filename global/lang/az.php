...
$LANG["text_add_form_step_3_para_2"] = "Note: if you're sending multiple values via checkboxes or a multi-select box, make sure your field name ends with the [] characters (see the <a href=\"http://docs.cloudservetechcentral.com/\" target=\"_blank\">user documentation</a> for more information).";
...
$LANG["text_install_email_content_text"] = "Bizim onlayn sənədlərimiz (https://docs.cloudservetechcentral.com) və təlimlər (https://docs.cloudservetechcentral.com/tutorials) daxil olmaqla, başlamanıza kömək etmək üçün veb səhifəmizdə çoxlu resurs var. Sıkıştığınız və ya bir sualınız varsa, github (https://github.com/formtools/core/issues/) haqqında bir sual soruşun.";
$LANG["text_install_form_tools_server_not_supported"] = "Sorry, CloudserveForms will not be able to run on your server. <a href=\"https://docs.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">Please click here</a> for the minimum requirements.";
