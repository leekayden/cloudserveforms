...
$LANG["text_add_form_help_link"] = "Если у вас возникли какие-либо проблемы во время этих шагов, попробуйте прочитать из <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">пользовательской документации</a> .";
...
$LANG["text_add_form_step_3_para_2"] = "Примечание: если вы отправляете несколько значений с помощью флажков или множественного выбора окна, убедитесь, что имя поля заканчивается символов [] (см. <a href=\"http://docs.forms.cloudservetechcentral.com/\" target=\"_blank\">Документация пользователя</a> для получения дополнительной информации).";
...
$LANG["text_install_email_content_text"] = "На нашем веб-сайте есть много ресурсов, которые помогут вам начать работу, включая нашу онлайн-документацию (https://docs.forms.cloudservetechcentral.com) и учебные пособия (https://docs.forms.cloudservetechcentral.com/tutorials). Если вы обнаружите, что застряли или задали вопрос, задайте вопрос о github (https://github.com/formtools/core/issues/).";
$LANG["text_install_form_tools_server_not_supported"] = "К сожалению, форма инструменты не будут иметь возможность запускать на вашем сервере. <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">Пожалуйста, нажмите здесь</a> для минимальных требований.";
...
$LANG["text_no_themes"] = "У вас нет ни одной темы определена. Нажмите на кнопку ниже, чтобы освежить свою тему списке, или проверить <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/themes/\">пользователя Форма Инструменты документации</a> для получения информации о добавлении темы.";
