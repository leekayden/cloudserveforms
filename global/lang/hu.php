...
$LANG["text_add_form_code_submission_benefits"] = "Ez a módszer a <a href=\"http://docs.forms.cloudservetechcentral.com/api/\" target=\"_blank\">CloudserveForms API</a> , amely szerepel a fő CloudserveForms script. Az API számos olyan hasznos funkciót, hogy a munka integrálása a formát Form eszközök a lehető legegyszerűbb. Nincsenek korlátozások, hogy milyen a formája lehet benyújtani, ha az API. Elküldheti a tartalmat egy menetben, vagy oldalanként, felveheti a saját egyéni szerver oldali validálás, CAPTCHA képek, választhat, hogy nyújtson be az információkat most, csak mondd meg, hogy megjelenjen a benyújtás a CloudserveForms UI egy későbbi időpontban (lásd a <a href=\"http://docs.forms.cloudservetechcentral.com/api/?page=finalized_submissions\">véglegesített Beadványok</a> részt a API segítségével dokumentációt).";
...
$LANG["text_add_form_help_link"] = "Ha befut bajt során ezeket a lépéseket, próbálja felolvasott <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">felhasználói dokumentáció</a> .";
...
$LANG["text_add_form_step_3_para_2"] = "Megjegyzés: Ha több értéket keresztül küldött jelölőnégyzeteket, vagy több legördülő lista, győződjön meg róla Ön neve mezőben végződik a [] karaktereket (lásd a <a href=\"http://docs.forms.cloudservetechcentral.com/\" target=\"_blank\">felhasználói dokumentációt</a> további információért).";
$LANG["text_add_form_step_3_text_1"] = "Itt, ahol a szórakozás kezdődik! Ezen a ponton, CloudserveForms vár egy teszt beadvány az űrlapot. Ez használja ezt az űrlapot benyújtott tudni, milyen információkat kell tárolni az adatbázisban.";
...
$LANG["text_form_tools_login_url"] = "A bejelentkezési URL-CloudserveForms.";
...
$LANG["text_install_create_database_tables"] = "Most fogunk létrehozni a CloudserveForms adatbázis táblák. Ez a lépés maga az adatbázis, hogy már létrejött. Ha nem biztos abban, hogyan kell ezt csinálni, vegye fel a kapcsolatot a tárhely szolgáltató.";
...
$LANG["text_install_email_content_text"] = "Rengeteg erőforrás van a honlapunkon, hogy segítsen neked elkezdeni, beleértve az online dokumentációt (https://docs.forms.cloudservetechcentral.com) és az oktatóanyagokat (https://docs.forms.cloudservetechcentral.com/tutorials). Ha úgy találja, hogy elakadt vagy kérdésed van, kérdezze meg a github-ot (https://github.com/formtools/core/issues/).";
$LANG["text_install_form_tools_server_not_supported"] = "Sajnálom, Form eszközök nem lesz képes futtatni a szerveren. <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">Kattintson ide</a> a minimális követelményeknek.";
...
$LANG["text_internal_form_desc"] = "A belső formák léteznek kizárólag CloudserveForms - máshol nem a webhelyen. Csak Form eszközök felhasználói fiókok férhetnek hozzá az űrlapot. Válassza ezt az opciót, ha nincs egy meglévő űrlapot.";
...
$LANG["text_no_themes"] = "Ön nincs téma határozza meg. Kattintson az alábbi gombra, hogy frissítse a téma listára, vagy ellenőrizze a <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/themes/\">Form eszközök felhasználói dokumentáció</a> az információk hozzáadásával témákat.";
...
$LANG["validation_upload_folder_not_writable"] = "Ez az ideiglenes feltölt megadott mappába a PHP nem írható. Amíg ez nem rögzített, fájlokat nem lehet feltölteni keresztül CloudserveForms (vagy bármilyen más PHP program). Kérjük, forduljon a tárhely szolgáltató.";
