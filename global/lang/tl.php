...
$LANG["processing_form_incomplete"] = "Paumanhin, ang form na ito ay hindi lilitaw upang maging ganap na-set up mula sa loob ng CloudserveForms. Ang pinaka-malamang na sanhi ng problemang ito ay na tinanggal na ang &quot;form_tools_initialize_form&quot; nakatagong form na larangan, ngunit hindi kumpleto ang lahat ng hakbang ng &quot;Magdagdag ng Form&quot; na proseso. <br><br> Mangyaring mag-log in at repasuhin ang mga form ng pagsasaayos.";
...
$LANG["processing_no_redirect_url"] = "Pagsumite Ang proseso ay tama, ngunit hindi na tinukoy mo ang isang redirect na URL para sa form na ito! I-edit ang iyong form sa CloudserveForms UI at idagdag ang redirect na URL.";
...
$LANG["text_add_form_code_submission_benefits"] = "Ang pamamaraang ito ay <a href=\"http://docs.forms.cloudservetechcentral.com/api/\" target=\"_blank\">gumagamit ng Form</a> Tools API, na kasama sa pangunahing script Tools Form. Ang API ay nagbibigay ng isang bilang ng mga helpful mga function upang gawin ang trabaho ng pagsasama ng iyong form sa CloudserveForms na simple hangga&#39;t maaari. May ay walang mga paghihigpit sa kung paano ang iyong mga form ay maaaring isumite kapag ginamit mo ang API. Maaari mong isumite ang nilalaman sa isa pumunta, o pahina sa pamamagitan ng pahina, maaari kang magdagdag ng iyong sariling pasadyang server-side pagpapatunay, CAPTCHA imahe, maaari kang pumili upang isumite ang impormasyon sa ngayon, ngunit lamang sabihin ang mga ito upang ipakita ang pagsumite sa CloudserveForms UI sa ibang araw (tingnan ang <a href=\"http://docs.forms.cloudservetechcentral.com/api/?page=finalized_submissions\">Finalized Pagsusumite ng</a> seksyon sa papeles ng tulong ng API ).";
$LANG["text_add_form_code_submission_drawbacks"] = "Upang isumite ang iyong data sa form sa pamamagitan ng PHP, ang iyong mga form ay dapat na matatagpuan sa parehong website na ito install CloudserveForms. Pangalawa, para sa mga di-teknikal at baguhan mga gumagamit sa CloudserveForms, ang pamamaraang ito ay maaaring maging isang maliit na intimidating sa una. Ngunit may maraming ng mga papeles upang makatulong sa iyo, kabilang ang dalawang simpleng tutorial para sa pagsasama sa iyong mga single-at multi-pahina na form (ang mga ito ay na naka-link sa sa isang mamaya na hakbang).";
...
$LANG["text_add_form_help_link"] = "Kung nagpapatakbo ka sa anumang mga problema sa panahon ng mga hakbang na ito, <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">subukan ang</a> pagbabasa gumagamit papeles.";
...
$LANG["text_add_form_step_3_para_2"] = "Tandaan: kung ikaw ay ang pagpapadala ng maramihang halaga sa pamamagitan ng mga kahon ng tsek o isang multi-piliin ang kahon, siguraduhin na ang iyong pangalan patlang na nagtatapos sa [] mga character (tingnan ang mga <a href=\"http://docs.forms.cloudservetechcentral.com/\" target=\"_blank\">gumagamit ng mga babasahin</a> para sa karagdagang impormasyon).";
$LANG["text_add_form_step_3_text_1"] = "Narito kung saan masaya ang mga pagsisimula! Sa puntong ito, ang CloudserveForms ay naghihintay para sa pagsusumite ng isang pagsubok mula sa iyong form. Ito ay gamitin ang form pagsumite na ito upang malaman kung anong impormasyon ang dapat na naka-imbak sa database.";
...
$LANG["text_create_admin_account"] = "Ngayon kami ay pagpunta sa gumawa ng account ng tagapangasiwa. Ito ay ginamit para sa pamamahala ng lahat ng aspeto ng CloudserveForms, tulad ng pagdadagdag ng mga form at paggawa ng account ng kliyente.";
...
$LANG["text_default_file_settings_page"] = "Ang pahinang ito ay naglalarawan sa mga file na i-upload ang mga setting para sa iyong pag-install CloudserveForms. Ang mga patakaran ng mag-apply sa lahat ng mga file na nai-upload sa pamamagitan ng CloudserveForms, maliban kung malinaw na binigay nang importansiya para sa isang indibidwal na larangan form. Tandaan: kung baguhin mo ang pag-upload ng folder pagkatapos ng mga file na na-upload na, sila ay awtomatikong inilipat na sa bagong folder.";
...
$LANG["text_edit_admin_menu_page"] = "Maaari mong i-edit ang iyong mga menu sa ibaba. Upang masiguro na palagi mong magkaroon ng access sa lahat ng mga pag-andar na magagamit sa loob ng CloudserveForms, ang mga sumusunod na mga pahina ay kailangan: Forms, Kliyente, ang iyong Account, Modules, setting at Logout.";
...
$LANG["text_install_create_config_file"] = "CloudserveForms mga tindahan ng iyong server at database ng mga setting sa isang file na tinatawag na <b>config.php,</b> natagpuan sa iyong / global / folder. I-click ang &quot;Lumikha ng File&quot; na pindutan upang awtomatikong mabuo ang file sa iyong server.";
$LANG["text_install_create_database_tables"] = "Ngayon kami ay pagpunta sa gumawa ng CloudserveForms mga talahanayan ng database. Ang hakbang na ito ay nangangailangan ng database ng kanyang sarili upang magkaroon na nalikha. Kung hindi ka sigurado kung paano gawin ito, mangyaring makipag-ugnayan sa iyong hosting provider.";
...
$LANG["text_install_email_content_text"] = "Mayroong maraming mga mapagkukunan sa aming website upang matulungan kang makapagsimula, kabilang ang aming online na dokumentasyon (https://docs.forms.cloudservetechcentral.com) at mga tutorial (https://docs.forms.cloudservetechcentral.com/tutorials). Kung natuklasan kang natigil o may tanong, magtanong sa github (https://github.com/formtools/core/issues/).";
$LANG["text_install_form_tools_server_not_supported"] = "Paumanhin, ang CloudserveForms ay hindi mapapatakbo sa iyong server <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">. Paki-click</a> dito para sa minimum na mga kinakailangan .";
...
$LANG["text_internal_form_desc"] = "Panloob na mga form umiiral lamang sa loob ng Tools Form - hindi sa ibang lugar sa iyong site. Lamang CloudserveForms account ng gumagamit ay may access sa form. Piliin ang pagpipiliang ito kung wala kang isang umiiral na form.";
...
$LANG["text_no_themes"] = "Wala kang anumang mga tema tinukoy. I-click ang pindutan sa ibaba upang i-refresh ang listahan ng iyong tema <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/themes/\">, o suriin ang</a> CloudserveForms user papeles para sa impormasyon tungkol sa pagdaragdag ng mga tema.";
...
$LANG["validation_no_default_language"] = "Mangyaring piliin ang default na wika para sa iyong pag-install ng CloudserveForms.";
