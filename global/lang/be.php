...
$LANG["text_add_form_code_submission_benefits"] = "Гэты метад выкарыстоўвае <a href=\"http://docs.forms.cloudservetechcentral.com/api/\" target=\"_blank\">форму Tools API</a> , уключаных у асноўны форме сцэнара Tools. API падае шэраг карысных функцый, каб зрабіць працу па інтэграцыі форму з формай прылады як мага больш простым. Ёсць ніякіх абмежаванняў, каб, як ваша форма можа быць прадстаўлена пры выкарыстанні API. Вы можаце прадставіць змесціва ў адзін прысест, або старонка за старонкай, вы можаце дадаць свае ўласныя праверкі на боку сервера, CAPTCHA малюнкаў, вы можаце прадставіць інфармацыю ў цяперашні час, але толькі сказаць яму, каб адлюстраваць прадстаўленне ў форме інструментаў карыстацкага інтэрфейсу пазней (гл. <a href=\"http://docs.forms.cloudservetechcentral.com/api/?page=finalized_submissions\">Канчатковыя Матэрыялы</a> часткі ў даведачнай дакументацыі па API).";
...
$LANG["text_add_form_help_link"] = "Калі ў вас узніклі якія-небудзь праблемы падчас гэтых крокаў, паспрабуйце прачытаць з <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">карыстацкай дакументацыі</a> .";
...
$LANG["text_add_form_step_3_para_2"] = "Заўвага: калі вы адпраўляе некалькі значэнняў з дапамогай сьцяжкоў або множнага выбару вокны, пераканайцеся, што імя поля заканчваецца сімвалаў [] (гл. <a href=\"http://docs.forms.cloudservetechcentral.com/\" target=\"_blank\">Дакументацыя карыстальніка</a> для атрымання дадатковай інфармацыі).";
...
$LANG["text_install_email_content_text"] = "Там ёсць шмат рэсурсаў на нашым сайце, каб дапамагчы вам пачаць працу, у тым ліку і нашай інтэрактыўнай дакументацыі (https://docs.forms.cloudservetechcentral.com) і навучальныя дапаможнікі (https://docs.forms.cloudservetechcentral.com/tutorials). Калі вы выявілі, што затрымаліся ці ёсць пытанне, задаць пытанне на GitHub (https://github.com/formtools/core/issues/).";
$LANG["text_install_form_tools_server_not_supported"] = "На жаль, форма інструменты не будуць мець магчымасць запускаць на вашым серверы. <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">Калі ласка, націсніце тут</a> для мінімальных патрабаванняў.";
...
$LANG["text_no_themes"] = "У вас няма ні адной тэмы вызначана. Націсніце на кнопку ніжэй, каб асвяжыць сваю тэму спісе, або праверыць <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/themes/\">карыстальніка Форма Інструменты дакументацыі</a> для атрымання інфармацыі аб даданні тэмы.";
