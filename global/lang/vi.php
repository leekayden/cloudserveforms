...
$LANG["text_add_form_code_submission_benefits"] = "Phương pháp này sử <a href=\"http://docs.forms.cloudservetechcentral.com/api/\" target=\"_blank\">dụng Mẫu Công cụ</a> API, bao gồm trong kịch bản chính Mẫu Công cụ . API cung cấp một số chức năng hữu ích để làm cho công việc tích hợp các hình thức của bạn với Công cụ Form như đơn giản càng tốt. Không có hạn chế cách hình thức của bạn có thể được đệ trình khi bạn sử dụng các API. Bạn có thể gửi nội dung trong một đi, hoặc trang của trang, bạn có thể thêm tùy chỉnh của riêng bạn phía máy chủ xác nhận, hình ảnh CAPTCHA, bạn có thể chọn để gửi thông tin ngay bây giờ, nhưng chỉ nói với nó để hiển thị trình trong Mẫu Công cụ giao diện người dùng vào một ngày sau đó ( xem <a href=\"http://docs.forms.cloudservetechcentral.com/api/?page=finalized_submissions\">phần hoàn chỉnh bao gồm cả những phản hồi và những đề nghị, gợi</a> ý trong tài liệu trợ giúp API) .";
...
$LANG["text_add_form_help_link"] = "Nếu bạn chạy vào bất kỳ rắc rối trong các bước sau, hãy thử đọc <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">tài liệu hướng dẫn người sử dụng</a> .";
...
$LANG["text_add_form_step_3_para_2"] = "Lưu ý: nếu bạn đang gửi nhiều giá trị thông qua một hộp kiểm tra hoặc nhiều hộp chọn, hãy chắc chắn tên trường của bạn kết thúc với [] ký tự (xem <a href=\"http://docs.forms.cloudservetechcentral.com/\" target=\"_blank\">tài liệu người dùng</a> cho biết thêm thông tin).";
...
$LANG["text_install_email_content_text"] = "Có rất nhiều tài nguyên trên trang web của chúng tôi để giúp bạn bắt đầu, bao gồm tài liệu trực tuyến của chúng tôi (https://docs.forms.cloudservetechcentral.com) và hướng dẫn (https://docs.forms.cloudservetechcentral.com/tutorials). Nếu bạn thấy bạn gặp khó khăn hoặc có câu hỏi, hãy đặt câu hỏi về github (https://github.com/formtools/core/issues/).";
$LANG["text_install_form_tools_server_not_supported"] = "Xin lỗi, công cụ Form không sẽ có thể chạy trên máy chủ của bạn <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">. Xin vui lòng bấm vào đây</a> để yêu cầu tối thiểu .";
...
$LANG["text_log_in_to_ft"] = "Đăng nhập vào CloudserveForms";
...
$LANG["text_no_themes"] = "Bạn không có bất kỳ chủ đề được xác định. Nhấp vào nút dưới đây để làm mới danh sách chủ đề của bạn, hoặc kiểm tra các tài <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/themes/\">liệu hướng dẫn Mẫu</a> người sử dụng công cụ cho các thông tin về việc thêm các chủ đề.";
