...
$LANG["processing_form_incomplete"] = "Omlouváme se, tato forma se nezdá být zcela nastavit zevnitř CloudserveForms. Nejpravděpodobnější příčinou tohoto problému je, že jste odebrali &quot;form_tools_initialize_form&quot; skrytého pole formuláře, ale nedokončil všechny kroky &quot;Přidat formuláře&quot; procesu. <br><br> Prosím přihlašte se, a přezkum podoby konfiguraci.";
...
$LANG["text_add_form_direct_submission_benefits"] = "To je nejjednodušší způsob, jak odeslat formulář CloudserveForms. Nevyžaduje žádné znalosti PHP a vyžaduje jen velmi malou změnou formy. Je to skvělé pro menší formy, kde chcete jen předložit informace k databázi, potom přesměrovat uživatele na &quot;Děkuju&quot; stránku.";
...
$LANG["text_add_form_help_link"] = "Pokud narazíte na nějaké potíže při těchto krocích, zkuste si přečíst z <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">uživatelské dokumentace</a> .";
...
$LANG["text_add_form_step_3_para_2"] = "Poznámka: pokud posíláte více hodnot pomocí zaškrtávacích nebo multi-vyberte pole, ujistěte se, že název pole, končí s [] znaky (viz <a href=\"http://docs.forms.cloudservetechcentral.com/\" target=\"_blank\">uživatelské dokumentaci</a> pro více informací).";
...
$LANG["text_install_email_content_text"] = "Na našich webových stránkách najdete spoustu zdrojů, které vám pomohou začít, včetně naší online dokumentace (https://docs.forms.cloudservetechcentral.com) a výukových programů (https://docs.forms.cloudservetechcentral.com/tutorials). Pokud zjistíte, že uvíznete nebo máte nějakou otázku, zeptejte se na otázku github (https://github.com/formtools/core/issues/).";
$LANG["text_install_form_tools_server_not_supported"] = "Omlouváme se, ale budou tvořit nástroje nebude moci běžet na serveru. <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">Prosím, klikněte zde</a> pro minimální požadavky.";
...
$LANG["text_no_themes"] = "Nemáte žádné definované témata. Klikněte na tlačítko níže, abyste si osvěžili tématu seznamu anebo se podívat <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/themes/\">tvarové nástroje uživatelské dokumentaci</a> pro informace o přidávání témata.";
