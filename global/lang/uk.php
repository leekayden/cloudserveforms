...
$LANG["text_add_form_help_link"] = "Якщо у вас виникли будь-які проблеми під час цих кроків, спробуйте прочитати з <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">користувацької документації</a> .";
...
$LANG["text_add_form_step_3_para_2"] = "Примітка: якщо ви додаєте кілька значень за допомогою прапорців або множинного вибору вікна, переконайтеся, що ім&#39;я поля закінчується символів [] (див. <a href=\"http://docs.forms.cloudservetechcentral.com/\" target=\"_blank\">Документація користувача</a> для отримання додаткової інформації).";
...
$LANG["text_install_email_content_text"] = "На нашому веб-сайті є велика кількість ресурсів, які допоможуть вам розпочати роботу, включаючи нашу онлайн-документацію (https://docs.forms.cloudservetechcentral.com) та навчальні посібники (https://docs.forms.cloudservetechcentral.com/tutorials). Якщо ви виявите, що ви застрягли або виникли запитання, задайте питання щодо github (https://github.com/formtools/core/issues/).";
$LANG["text_install_form_tools_server_not_supported"] = "На жаль, форма інструменти не будуть мати можливість запускати на вашому сервері. <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">Будь ласка, натисніть тут</a> для мінімальних вимог.";
...
$LANG["text_no_themes"] = "У вас немає жодної теми визначена. Натисніть на кнопку нижче, щоб освіжити свою тему списку, або перевірити <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/themes/\">користувача Форма Інструменти документації</a> для отримання інформації про додавання теми.";
