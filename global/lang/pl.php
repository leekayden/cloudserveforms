...
$LANG["text_add_form_help_link"] = "Jeśli napotkasz jakiekolwiek problemy podczas czynności, spróbuj odczytywania <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">dokumentacji użytkownika</a> .";
...
$LANG["text_add_form_step_3_para_2"] = "Uwaga: Jeśli wysyłasz wiele wartości poprzez pola wyboru lub wielo-wybierz pole, upewnij się, że nazwa pola kończy się [] znaków (patrz <a href=\"http://docs.forms.cloudservetechcentral.com/\" target=\"_blank\">dokumentacja</a> uzyskać więcej informacji).";
...
$LANG["text_form_tools_login_url"] = "URL logowania do CloudserveForms.";
...
$LANG["text_install_email_content_text"] = "Na naszej stronie znajdziesz mnóstwo zasobów, które pomogą Ci zacząć, w tym naszą dokumentację online (https://docs.forms.cloudservetechcentral.com) i samouczki (https://docs.forms.cloudservetechcentral.com/tutorials). Jeśli zauważysz, że utknąłeś lub masz pytanie, zadaj pytanie na github (https://github.com/formtools/core/issues/).";
$LANG["text_install_form_tools_server_not_supported"] = "Przykro nam, Narzędzia Formularz nie będzie w stanie uruchomić na serwerze. <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">Proszę kliknąć tutaj</a> na minimalne wymagania.";
...
$LANG["text_no_themes"] = "Nie masz żadnych tematów zdefiniowane. Kliknij przycisk poniżej, aby odświeżyć listę tematów, lub sprawdzić <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/themes/\">Formularz użytkownika Narzędzia dokumentacji</a> dla informacji na temat dodawania motywów.";
...
$LANG["validation_no_default_language"] = "Wybierz domyślny język twojej instalacji CloudserveForms.";
