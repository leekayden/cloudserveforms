...
$LANG["notify_no_test_submission"] = "CloudserveForms har ikke modtaget en vellykket test indsendelse endnu.";
...
$LANG["phrase_new_ft_installation"] = "Ny CloudserveForms Installation";
...
$LANG["processing_no_form_url_for_recaptcha"] = "CloudserveForms er i stand til at afgøre, hvor omdirigere, når de undlader at indtaste CAPTCHA korrekt. Please passere i et skjult felt med navnet <b>form_tools_form_url</b> indeholder URL&#39;en i skemaet.";
...
$LANG["text_add_form_help_link"] = "Hvis du løber ind i nogen problemer i løbet af disse trin, så prøv at læse ud af <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">brugerdokumentation</a> .";
...
$LANG["text_add_form_step_3_para_2"] = "Bemærk: Hvis du sender flere værdier ved hjælp af afkrydsningsfelter eller en multi-vælg feltet, skal du sørge for dit område navn ender med [] tegn (se <a href=\"http://docs.forms.cloudservetechcentral.com/\" target=\"_blank\">brugeren dokumentationen</a> for mere information).";
...
$LANG["text_add_form_step_3_text_2"] = "ved at pege din form til CloudserveForms";
...
$LANG["text_config_file_not_created_instructions"] = "Kopier og indsæt indholdet fra afsnittet nedenfor i en fil kaldet config.php og upload det via FTP til den CloudserveForms / globale mappe (den mappe, der også indeholder et par andre filer og mapper, en fil kaldet library.php).";
...
$LANG["text_edit_admin_menu_page"] = "Du kan redigere din menuen nedenfor. At sikre, at du altid har adgang til alle funktioner tilgængelige inden CloudserveForms, de følgende sider er påkrævet: Forms, Kunder, din konto, Moduler, Indstillinger og Log af.";
...
$LANG["text_form_tools_login_url"] = "Login URL til CloudserveForms.";
...
$LANG["text_ft_installed"] = "Tillykke, har CloudserveForms blevet installeret!";
...
$LANG["text_install_email_content_text"] = "Der er masser af ressourcer på vores hjemmeside for at hjælpe dig med at komme i gang, herunder vores online dokumentation (https://docs.forms.cloudservetechcentral.com) og selvstudier (https://docs.forms.cloudservetechcentral.com/tutorials). Hvis du finder dig fast eller har et spørgsmål, still et spørgsmål på github (https://github.com/formtools/core/issues/).";
$LANG["text_install_form_tools_server_not_supported"] = "Beklager, vil Formværktøj ikke være i stand til at køre på din server. <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/form_management/adding_external_forms/\" target=\"_blank\">Klik her</a> for minimumskravene.";
$LANG["text_install_system_check"] = "Denne side kører et par test på dit system for at sikre, at det er i stand til at køre CloudserveForms.";
...
$LANG["text_js_required"] = "For at logge ind og bruge CloudserveForms, skal du have javascript aktiveret i din browser. Aktiver venligst nu, og tryk opdater i din browser.";
...
$LANG["text_no_themes"] = "Du har ikke nogen defineret temaer. Klik på knappen nedenfor for at opdatere dit tema listen, eller tjek <a href=\"https://docs.forms.cloudservetechcentral.com/userdoc/themes/\">Formværktøj brugerdokumentation</a> for at få oplysninger om tilføjelse af temaer.";
...
$LANG["validation_no_default_language"] = "Vælg venligst standard sprog for din installation af CloudserveForms.";
...
$LANG["validation_upload_folder_not_writable"] = "Der er ikke adgang til at skrive i den midlertidige upload mappe du har specificeret i din PHP installation. Indtil dette er rettet, kan filer ikke uploades via CloudserveForms (eller andre PHP programmer). Kontakt venligst din webhost.";
