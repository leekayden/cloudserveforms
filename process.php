 ...
 * File: process.php
 *
 * This file processes any form submissions for forms already added and configured within CloudserveForms. To
 * use it, just point your form to this file, like so:
 *
 *   <form method="post" action="/path/to/process.php">
 *
 * Once the form has been added through the CloudserveForms UI, this script parses the form contents
