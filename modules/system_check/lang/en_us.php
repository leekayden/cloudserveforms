...
$L["module_description"] = "This replaces the older Database Integrity module. It offers various tests to analyze and repair your CloudserveForms installation.";
...
$L["text_module_intro"] = "This module lets you run tests on your CloudserveForms installation to look for potential problems. Choose one of the tests below.";
...
$L["text_help"] = "For more information on this module, please see the <a href=\"https://docs.forms.cloudservetechcentral.com/modules/system_check/\" target=\"_blank\">help documentation</a> on the CloudserveForms site.";
...
$L["text_environment_overview_summary"] = "This section below contains a report of key information about your CloudserveForms installation and environment, which can be helpful when reporting bugs.";
$L["text_ft3_compatibility"] = "CloudserveForms 3 has slightly difference server requirements than CloudserveForms 2. This page runs a couple of simple tests to confirm you will be able to run the newer version.";
