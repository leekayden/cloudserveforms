...
$L["module_description"] = "Publish any CloudserveForms form to make it publicly available on your website.";
...
$L["text_template_set_intro"] = "The Form Builder module provides a new \"Publish\" tab when editing your form, which you can use to publish the forms you configure within CloudserveForms onto your own site. The table below lists all available Template Sets, which are used to control the appearance of your published forms.";
...
$L["text_form_builder_add_form_section"] = "This creates a new form that's been configured with the Form Builder. Form Builder forms are forms that are created and managed within the CloudserveForms interface, but published on your own website.";
...
$L["text_help"] = "For help on how to use this module, please see the <a href=\"https://docs.forms.cloudservetechcentral.com/modules/form_builder/\" target=\"_blank\">online help documentation</a>.";
...
$L["text_add_form_access_hint"] = "This setting controls which CloudserveForms users get access to the data.";
